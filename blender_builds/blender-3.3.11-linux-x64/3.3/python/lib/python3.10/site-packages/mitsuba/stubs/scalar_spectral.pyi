...
class AdjointIntegrator(Integrator):
    ...
    def aov_names(self: mitsuba.scalar_spectral.Integrator) -> List[str]:
        """
    ...
    def cancel(self: mitsuba.scalar_spectral.Integrator) -> None:
        """
    ...
    @overload
    def render(self: mitsuba.scalar_spectral.Integrator, scene: mitsuba.scalar_spectral.Scene, sensor, seed: int = 0, spp: int = 0, develop: bool = True, evaluate: bool = True) -> drjit.scalar.TensorXf:
        """
        Render the scene
    ...
    @overload
    def render(self: mitsuba.scalar_spectral.Integrator, scene: mitsuba.scalar_spectral.Scene, sensor: int = 0, seed: int = 0, spp: int = 0, develop: bool = True, evaluate: bool = True) -> drjit.scalar.TensorXf:
        """
        Render the scene
    ...
    def sample(self: mitsuba.scalar_spectral.AdjointIntegrator, scene: mitsuba.scalar_spectral.Scene, sensor, sampler, block: mitsuba.scalar_spectral.ImageBlock, sample_scale: float) -> None:
        """
    ...
    def should_stop(self: mitsuba.scalar_spectral.Integrator) -> bool:
        """
...
class BSDF(Object):
    ...
    def __init__(self: mitsuba.scalar_spectral.BSDF, props: mitsuba.Properties) -> None: ...
    m_components = ...
    m_flags = ...
    ptr = ...

    def component_count(self: mitsuba.scalar_spectral.BSDF, active: bool = True) -> int:
        """
    ...
    def eval(self: mitsuba.scalar_spectral.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.scalar_spectral.SurfaceInteraction3f, wo: mitsuba.Vector3f, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
    ...
    def eval_null_transmission(self: mitsuba.scalar_spectral.BSDF, si: mitsuba.scalar_spectral.SurfaceInteraction3f, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
    ...
    def eval_pdf(self: mitsuba.scalar_spectral.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.scalar_spectral.SurfaceInteraction3f, wo: mitsuba.Vector3f, active: bool = True) -> Tuple[mitsuba.scalar_spectral.Spectrum, float]:
        """
    ...
    @overload
    def flags(self: mitsuba.scalar_spectral.BSDF, index: int, active: bool = True) -> int:
        """
    ...
    @overload
    def flags(self: mitsuba.scalar_spectral.BSDF) -> int:
        """
        Flags for all components combined.
        """
        ...

    def id(self: mitsuba.scalar_spectral.BSDF) -> str:
        """
    ...
    def needs_differentials(self: mitsuba.scalar_spectral.BSDF) -> bool:
        """
    ...
    def pdf(self: mitsuba.scalar_spectral.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.scalar_spectral.SurfaceInteraction3f, wo: mitsuba.Vector3f, active: bool = True) -> float:
        """
    ...
    def sample(self: mitsuba.scalar_spectral.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.scalar_spectral.SurfaceInteraction3f, sample1: float, sample2: mitsuba.Point2f, active: bool = True) -> Tuple[mitsuba.scalar_spectral.BSDFSample3f, mitsuba.scalar_spectral.Spectrum]:
        """
...
class BSDFSample3f:
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.BSDFSample3f) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.BSDFSample3f, wo: mitsuba.Vector3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.BSDFSample3f, bs: mitsuba.scalar_spectral.BSDFSample3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def assign(self: mitsuba.scalar_spectral.BSDFSample3f, arg0: mitsuba.scalar_spectral.BSDFSample3f) -> None: ...
    ...
...
class ContinuousDistribution:
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.ContinuousDistribution) -> None:
        """
        Continuous 1D probability distribution defined in terms of a regularly
        sampled linear interpolant
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.ContinuousDistribution, arg0: mitsuba.scalar_spectral.ContinuousDistribution) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.ContinuousDistribution, range: mitsuba.Vector2f, pdf: drjit.scalar.ArrayXf) -> None:
        """
        Initialize from a given density function on the interval ``range``
        """
        ...

    def cdf(self: mitsuba.scalar_spectral.ContinuousDistribution) -> drjit.scalar.ArrayXf:
        """
    ...
    def empty(self: mitsuba.scalar_spectral.ContinuousDistribution) -> bool:
        """
        Is the distribution object empty/uninitialized?
        """
        ...

    def eval_cdf(self: mitsuba.scalar_spectral.ContinuousDistribution, x: float, active: bool = True) -> float:
        """
    ...
    def eval_cdf_normalized(self: mitsuba.scalar_spectral.ContinuousDistribution, x: float, active: bool = True) -> float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        position ``p``
        """
    ...
    def eval_pdf(self: mitsuba.scalar_spectral.ContinuousDistribution, x: float, active: bool = True) -> float:
        """
    ...
    def eval_pdf_normalized(self: mitsuba.scalar_spectral.ContinuousDistribution, x: float, active: bool = True) -> float:
        """
    ...
    def integral(self: mitsuba.scalar_spectral.ContinuousDistribution) -> float:
        """
        Return the original integral of PDF entries before normalization
        """
        ...

    def interval_resolution(self: mitsuba.scalar_spectral.ContinuousDistribution) -> float:
        """
        Return the minimum resolution of the discretization
        """
        ...

    def normalization(self: mitsuba.scalar_spectral.ContinuousDistribution) -> float:
        """
        Return the normalization factor (i.e. the inverse of sum())
        """
        ...

    def pdf(self: mitsuba.scalar_spectral.ContinuousDistribution) -> drjit.scalar.ArrayXf:
        """
        Return the unnormalized discretized probability density function
        """
        ...

    def range(self: mitsuba.scalar_spectral.ContinuousDistribution) -> mitsuba.Vector2f:
        """
        Return the range of the distribution
        """
        ...

    def sample(self: mitsuba.scalar_spectral.ContinuousDistribution, value: float, active: bool = True) -> float:
        """
    ...
    def sample_pdf(self: mitsuba.scalar_spectral.ContinuousDistribution, value: float, active: bool = True) -> Tuple[float, float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def size(self: mitsuba.scalar_spectral.ContinuousDistribution) -> int:
        """
        Return the number of discretizations
        """
        ...

    def update(self: mitsuba.scalar_spectral.ContinuousDistribution) -> None:
        """
...
class CppADIntegrator(SamplingIntegrator):
    def __init__(self: mitsuba.scalar_spectral.CppADIntegrator, arg0: mitsuba.Properties) -> None: ...
    ptr = ...
    ...
    def sample(self: mitsuba.scalar_spectral.SamplingIntegrator, scene: mitsuba.scalar_spectral.Scene, sampler, ray: mitsuba.scalar_spectral.RayDifferential3f, medium: mitsuba.scalar_spectral.Medium = None, active: bool = True) -> Tuple[mitsuba.scalar_spectral.Spectrum, bool, List[float]]:
        """
...
class DirectionSample3f(PositionSample3f):
    ...
    *direct illumination strategies* importance sample the incident
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.DirectionSample3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.DirectionSample3f, other: mitsuba.scalar_spectral.PositionSample3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.DirectionSample3f, other: mitsuba.scalar_spectral.DirectionSample3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.DirectionSample3f, p: mitsuba.Point3f, n: mitsuba.Normal3f, uv: mitsuba.Point2f, time: float, pdf: float, delta: bool, d: mitsuba.Vector3f, dist: float, emitter: mitsuba.scalar_spectral.Emitter) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.DirectionSample3f, scene: mitsuba.scalar_spectral.Scene, si: mitsuba.scalar_spectral.SurfaceInteraction3f, ref: mitsuba.scalar_spectral.Interaction3f) -> None:
        """
    ...
    def assign(self: mitsuba.scalar_spectral.DirectionSample3f, arg0: mitsuba.scalar_spectral.DirectionSample3f) -> None: ...
    ...
...
class DiscreteDistribution:
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.DiscreteDistribution) -> None:
        """
        Discrete 1D probability distribution
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.DiscreteDistribution, arg0: mitsuba.scalar_spectral.DiscreteDistribution) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.DiscreteDistribution, pmf: drjit.scalar.ArrayXf) -> None:
        """
        Initialize from a given probability mass function
        """
        ...

    def cdf(self: mitsuba.scalar_spectral.DiscreteDistribution) -> drjit.scalar.ArrayXf:
        """
        Return the unnormalized cumulative distribution function
        """
        ...

    def empty(self: mitsuba.scalar_spectral.DiscreteDistribution) -> bool:
        """
        Is the distribution object empty/uninitialized?
        """
        ...

    def eval_cdf(self: mitsuba.scalar_spectral.DiscreteDistribution, index: int, active: bool = True) -> float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        index ``index``
        """
    ...
    def eval_cdf_normalized(self: mitsuba.scalar_spectral.DiscreteDistribution, index: int, active: bool = True) -> float:
        """
    ...
    def eval_pmf(self: mitsuba.scalar_spectral.DiscreteDistribution, index: int, active: bool = True) -> float:
        """
    ...
    def eval_pmf_normalized(self: mitsuba.scalar_spectral.DiscreteDistribution, index: int, active: bool = True) -> float:
        """
    ...
    def normalization(self: mitsuba.scalar_spectral.DiscreteDistribution) -> float:
        """
        Return the normalization factor (i.e. the inverse of sum())
        """
        ...

    def pmf(self: mitsuba.scalar_spectral.DiscreteDistribution) -> drjit.scalar.ArrayXf:
        """
        Return the unnormalized probability mass function
        """
        ...

    def sample(self: mitsuba.scalar_spectral.DiscreteDistribution, value: float, active: bool = True) -> int:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_pmf(self: mitsuba.scalar_spectral.DiscreteDistribution, value: float, active: bool = True) -> Tuple[int, float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_reuse(self: mitsuba.scalar_spectral.DiscreteDistribution, value: float, active: bool = True) -> Tuple[int, float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_reuse_pmf(self: mitsuba.scalar_spectral.DiscreteDistribution, value: float, active: bool = True) -> Tuple[int, float, float]:
        """
        %Transform a uniformly distributed sample to the stored distribution.
    ...
    def size(self: mitsuba.scalar_spectral.DiscreteDistribution) -> int:
        """
        Return the number of entries
        """
        ...

    def sum(self: mitsuba.scalar_spectral.DiscreteDistribution) -> float:
        """
        Return the original sum of PMF entries before normalization
        """
        ...

    def update(self: mitsuba.scalar_spectral.DiscreteDistribution) -> None:
        """
...
class DiscreteDistribution2D:
    def __init__(self: mitsuba.scalar_spectral.DiscreteDistribution2D, data: numpy.ndarray[numpy.float32]) -> None: ...
    def eval(self: mitsuba.scalar_spectral.DiscreteDistribution2D, pos: mitsuba.Point2u, active: bool = True) -> float: ...
    def pdf(self: mitsuba.scalar_spectral.DiscreteDistribution2D, pos: mitsuba.Point2u, active: bool = True) -> float: ...
    def sample(self: mitsuba.scalar_spectral.DiscreteDistribution2D, sample: mitsuba.Point2f, active: bool = True) -> Tuple[mitsuba.Point2u, float, mitsuba.Point2f]: ...
    ...
...
class Emitter(Endpoint):
    def __init__(self: mitsuba.scalar_spectral.Emitter, arg0: mitsuba.Properties) -> None: ...
    m_flags = ...
    m_needs_sample_2 = ...
    m_needs_sample_3 = ...
    ptr = ...

    def bbox(self: mitsuba.scalar_spectral.Endpoint) -> mitsuba.BoundingBox3f:
        """
    ...
    def eval(self: mitsuba.scalar_spectral.Endpoint, si, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
    ...
    def eval_direction(self: mitsuba.scalar_spectral.Endpoint, it, ds, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
    ...
    def flags(self: mitsuba.scalar_spectral.Emitter, active: bool = True) -> int:
        """
        Flags for all components combined.
        """
        ...
    ...
    def is_environment(self: mitsuba.scalar_spectral.Emitter) -> bool:
        """
        Is this an environment map light emitter?
        """
        ...

    def medium(self: mitsuba.scalar_spectral.Endpoint) -> mitsuba.scalar_spectral.Medium:
        """
        Return a pointer to the medium that surrounds the emitter
        """
        ...

    def needs_sample_2(self: mitsuba.scalar_spectral.Endpoint) -> bool:
        """
    ...
    def needs_sample_3(self: mitsuba.scalar_spectral.Endpoint) -> bool:
        """
        Does the method sample_ray() require a uniformly distributed 2D sample
    ...
    def pdf_direction(self: mitsuba.scalar_spectral.Endpoint, it, ds, active: bool = True) -> float:
        """
    ...
    def sample_direction(self: mitsuba.scalar_spectral.Endpoint, it, sample: mitsuba.Point2f, active: bool = True):
        """
    ...
    def sample_ray(self: mitsuba.scalar_spectral.Endpoint, time: float, sample1: float, sample2: mitsuba.Point2f, sample3: mitsuba.Point2f, active: bool = True) -> Tuple[mitsuba.scalar_spectral.Ray3f, mitsuba.scalar_spectral.Spectrum]:
        """
    ...
    def sample_wavelengths(self: mitsuba.scalar_spectral.Endpoint, si, sample: float, active: bool = True) -> Tuple[mitsuba.scalar_spectral.Spectrum, mitsuba.scalar_spectral.Spectrum]:
        """
    ...
    def set_medium(self: mitsuba.scalar_spectral.Endpoint, medium: mitsuba.scalar_spectral.Medium) -> None:
        """
        Set the medium that surrounds the emitter.
        """
        ...

    def set_scene(self: mitsuba.scalar_spectral.Endpoint, scene: mitsuba.scalar_spectral.Scene) -> None:
        """
    ...
    def set_shape(self: mitsuba.scalar_spectral.Endpoint, shape: mitsuba.scalar_spectral.Shape) -> None:
        """
        Set the shape associated with this endpoint.
        """
        ...

    def shape(self: mitsuba.scalar_spectral.Endpoint) -> mitsuba.scalar_spectral.Shape:
        """
    ...
    def world_transform(self: mitsuba.scalar_spectral.Endpoint) -> mitsuba.Transform4f:
        """
...
class Film(Object):
    ...
    def bitmap(self: mitsuba.scalar_spectral.Film, raw: bool = False) -> mitsuba.Bitmap:
        """
        Return a bitmap object storing the developed contents of the film
        """
        ...

    def create_block(self: mitsuba.scalar_spectral.Film, size: mitsuba.Vector2u = [0, 0], normalize: bool = False, borders: bool = False):
        """
    ...
    def crop_offset(self: mitsuba.scalar_spectral.Film) -> mitsuba.Point2u:
        """
        Return the offset of the crop window
        """
        ...

    def crop_size(self: mitsuba.scalar_spectral.Film) -> mitsuba.Vector2u:
        """
    ...
    def develop(self: mitsuba.scalar_spectral.Film, raw: bool = False) -> drjit.scalar.TensorXf:
        """
    ...
    def flags(self: mitsuba.scalar_spectral.Film) -> int:
        """
    ...
    def prepare(self: mitsuba.scalar_spectral.Film, aovs: List[str]) -> int:
        """
    ...
    def prepare_sample(self: mitsuba.scalar_spectral.Film, spec: mitsuba.scalar_spectral.Spectrum, wavelengths: mitsuba.scalar_spectral.Spectrum, nChannels: int, weight: float = 1.0, alpha: float = 1.0, active: bool = True) -> List[float]:
        """
    ...
    def put_block(self: mitsuba.scalar_spectral.Film, block) -> None:
        """
    ...
    def rfilter(self: mitsuba.scalar_spectral.Film) -> mitsuba.scalar_spectral.ReconstructionFilter:
        """
        Return the image reconstruction filter (const version)
        """
        ...

    def sample_border(self: mitsuba.scalar_spectral.Film) -> bool:
        """
    ...
    def schedule_storage(self: mitsuba.scalar_spectral.Film) -> None:
        """
        dr::schedule() variables that represent the internal film storage
        """
        ...

    def sensor_response_function(self: mitsuba.scalar_spectral.Film):
        """
        Returns the specific Sensor Response Function (SRF) used by the film
        """
        ...

    def set_crop_window(self: mitsuba.scalar_spectral.Film, crop_offset: mitsuba.Point2u, crop_size: mitsuba.Vector2u) -> None:
        """
    ...
    def set_size(self: mitsuba.scalar_spectral.Film, size: mitsuba.Point2u) -> None:
        """
    ...
    def size(self: mitsuba.scalar_spectral.Film) -> mitsuba.Vector2u:
        """
    ...
    def write(self: mitsuba.scalar_spectral.Film, path: mitsuba.filesystem.path) -> None:
        """
...
class Hierarchical2D0:
    ...
    def __init__(self: mitsuba.scalar_spectral.Hierarchical2D0, data: numpy.ndarray[numpy.float32], param_values: List[List[float][0]] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
    ...
    def eval(self: mitsuba.scalar_spectral.Hierarchical2D0, pos: drjit.scalar.Array2f, param: drjit.scalar.Array0f = [], active: bool = True) -> float:
        """
    ...
    def invert(self: mitsuba.scalar_spectral.Hierarchical2D0, sample: drjit.scalar.Array2f, param: drjit.scalar.Array0f = [], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.Hierarchical2D0, sample: drjit.scalar.Array2f, param: drjit.scalar.Array0f = [], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
...
class Hierarchical2D1:
    ...
    def __init__(self: mitsuba.scalar_spectral.Hierarchical2D1, data: numpy.ndarray[numpy.float32], param_values: List[List[float][1]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.Hierarchical2D1, pos: drjit.scalar.Array2f, param: drjit.scalar.Array1f = [0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.Hierarchical2D1, sample: drjit.scalar.Array2f, param: drjit.scalar.Array1f = [0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.Hierarchical2D1, sample: drjit.scalar.Array2f, param: drjit.scalar.Array1f = [0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Hierarchical2D2:
    ...
    def __init__(self: mitsuba.scalar_spectral.Hierarchical2D2, data: numpy.ndarray[numpy.float32], param_values: List[List[float][2]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.Hierarchical2D2, pos: drjit.scalar.Array2f, param: drjit.scalar.Array2f = [0.0, 0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.Hierarchical2D2, sample: drjit.scalar.Array2f, param: drjit.scalar.Array2f = [0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.Hierarchical2D2, sample: drjit.scalar.Array2f, param: drjit.scalar.Array2f = [0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Hierarchical2D3:
    ...
    def __init__(self: mitsuba.scalar_spectral.Hierarchical2D3, data: numpy.ndarray[numpy.float32], param_values: List[List[float][3]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.Hierarchical2D3, pos: drjit.scalar.Array2f, param: drjit.scalar.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.Hierarchical2D3, sample: drjit.scalar.Array2f, param: drjit.scalar.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.Hierarchical2D3, sample: drjit.scalar.Array2f, param: drjit.scalar.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class ImageBlock(Object):
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.ImageBlock, size: mitsuba.Vector2u, offset: mitsuba.Point2i, channel_count: int, rfilter: mitsuba.scalar_spectral.ReconstructionFilter = None, border: bool = True, normalize: bool = False, coalesce: bool = False, warn_negative: bool = True, warn_invalid: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.ImageBlock, tensor: drjit.scalar.TensorXf, offset: mitsuba.Point2i = [0, 0], rfilter: mitsuba.scalar_spectral.ReconstructionFilter = None, border: bool = True, normalize: bool = False, coalesce: bool = False, warn_negative: bool = True, warn_invalid: bool = True) -> None: ...
    ptr = ...

    def border_size(self: mitsuba.scalar_spectral.ImageBlock) -> int:
        """
        Return the border region used by the reconstruction filter
        """
        ...

    def channel_count(self: mitsuba.scalar_spectral.ImageBlock) -> int:
        """
        Return the number of channels stored by the image block
        """
        ...

    def clear(self: mitsuba.scalar_spectral.ImageBlock) -> None:
        """
        Clear the image block contents to zero.
        """
        ...

    def coalesce(self: mitsuba.scalar_spectral.ImageBlock) -> bool:
        """
    ...
    def has_border(self: mitsuba.scalar_spectral.ImageBlock) -> bool:
        """
        Does the image block have a border region?
        """
        ...

    def height(self: mitsuba.scalar_spectral.ImageBlock) -> int:
        """
        Return the bitmap's height in pixels
        """
        ...
    ...
    def normalize(self: mitsuba.scalar_spectral.ImageBlock) -> bool:
        """
        Re-normalize filter weights in put() and read()
        """
        ...

    def offset(self: mitsuba.scalar_spectral.ImageBlock) -> mitsuba.Point2i:
        """
    ...
    @overload
    def put(self: mitsuba.scalar_spectral.ImageBlock, pos: mitsuba.Point2f, wavelengths: mitsuba.scalar_spectral.Spectrum, value: mitsuba.scalar_spectral.Spectrum, alpha: float = 1.0, weight: float = 1, active: bool = True) -> None:
        """
    ...
    @overload
    def put(self: mitsuba.scalar_spectral.ImageBlock, pos: mitsuba.Point2f, values: List[float], active: bool = True) -> None: ...
    def put_block(self: mitsuba.scalar_spectral.ImageBlock, block: mitsuba.scalar_spectral.ImageBlock) -> None:
        """
        Accumulate a single sample or a wavefront of samples into the image
        block.
    ...
    def read(self: mitsuba.scalar_spectral.ImageBlock, pos: mitsuba.Point2f, active: bool = True) -> List[float]: ...
    def ref_count(self: mitsuba.Object) -> int:
        """
        Return the current reference count
        """
    ...
    def rfilter(self: mitsuba.scalar_spectral.ImageBlock) -> mitsuba.scalar_spectral.ReconstructionFilter:
        """
        Return the image reconstruction filter underlying the ImageBlock
        """
        ...

    def set_coalesce(self: mitsuba.scalar_spectral.ImageBlock, arg0: bool) -> None:
        """
        Try to coalesce reads/writes in JIT modes?
        """
        ...
    ...
    def set_normalize(self: mitsuba.scalar_spectral.ImageBlock, arg0: bool) -> None:
        """
        Re-normalize filter weights in put() and read()
        """
        ...

    def set_offset(self: mitsuba.scalar_spectral.ImageBlock, offset: mitsuba.Point2i) -> None:
        """
    ...
    def set_size(self: mitsuba.scalar_spectral.ImageBlock, size: mitsuba.Vector2u) -> None:
        """
        Set the block size. This potentially destroys the block's content.
        """
        ...

    def set_warn_invalid(self: mitsuba.scalar_spectral.ImageBlock, value: bool) -> None:
        """
        Warn when writing invalid (NaN, +/- infinity) sample values?
        """
        ...

    def set_warn_negative(self: mitsuba.scalar_spectral.ImageBlock, value: bool) -> None:
        """
        Warn when writing negative sample values?
        """
        ...

    def size(self: mitsuba.scalar_spectral.ImageBlock) -> mitsuba.Vector2u:
        """
        Return the current block size
        """
        ...

    def tensor(self: mitsuba.scalar_spectral.ImageBlock) -> drjit.scalar.TensorXf:
        """
    ...
    def warn_invalid(self: mitsuba.scalar_spectral.ImageBlock) -> bool:
        """
        Warn when writing invalid (NaN, +/- infinity) sample values?
        """
        ...

    def warn_negative(self: mitsuba.scalar_spectral.ImageBlock) -> bool:
        """
        Warn when writing negative sample values?
        """
        ...

    def width(self: mitsuba.scalar_spectral.ImageBlock) -> int:
        """
        Return the bitmap's width in pixels
        """
        ...
...
class Interaction3f:
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Interaction3f) -> None:
        """
        Constructor
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Interaction3f, arg0: mitsuba.scalar_spectral.Interaction3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Interaction3f, t: float, time: float, wavelengths: mitsuba.scalar_spectral.Spectrum, p: mitsuba.Point3f, n: mitsuba.Normal3f = 0) -> None: ...
    n = ...
    ...
    def assign(self: mitsuba.scalar_spectral.Interaction3f, arg0: mitsuba.scalar_spectral.Interaction3f) -> None: ...
    def is_valid(self: mitsuba.scalar_spectral.Interaction3f) -> bool:
        """
        Is the current interaction valid?
        """
        ...

    def spawn_ray(self: mitsuba.scalar_spectral.Interaction3f, d: mitsuba.Vector3f) -> mitsuba.scalar_spectral.Ray3f:
        """
        Spawn a semi-infinite ray towards the given direction
        """
        ...

    def spawn_ray_to(self: mitsuba.scalar_spectral.Interaction3f, t: mitsuba.Point3f) -> mitsuba.scalar_spectral.Ray3f:
        """
...
class IrregularContinuousDistribution:
    ...
    *irregularly* sampled linear interpolant
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> None:
        """
        Continuous 1D probability distribution defined in terms of an
        *irregularly* sampled linear interpolant
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.IrregularContinuousDistribution, arg0: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.IrregularContinuousDistribution, nodes: drjit.scalar.ArrayXf, pdf: drjit.scalar.ArrayXf) -> None:
        """
    ...
    def cdf(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> drjit.scalar.ArrayXf:
        """
        Return the unnormalized discrete cumulative distribution function over
        intervals
        """
    ...
    def empty(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> bool:
        """
        Is the distribution object empty/uninitialized?
        """
        ...

    def eval_cdf(self: mitsuba.scalar_spectral.IrregularContinuousDistribution, x: float, active: bool = True) -> float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        position ``p``
        """
    ...
    def eval_cdf_normalized(self: mitsuba.scalar_spectral.IrregularContinuousDistribution, x: float, active: bool = True) -> float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        position ``p``
        """
    ...
    def eval_pdf(self: mitsuba.scalar_spectral.IrregularContinuousDistribution, x: float, active: bool = True) -> float:
        """
        Evaluate the unnormalized probability mass function (PDF) at position
        ``x``
        """
    ...
    def eval_pdf_normalized(self: mitsuba.scalar_spectral.IrregularContinuousDistribution, x: float, active: bool = True) -> float:
        """
        Evaluate the normalized probability mass function (PDF) at position
        ``x``
        """
    ...
    def integral(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> float:
        """
        Return the original integral of PDF entries before normalization
        """
        ...

    def interval_resolution(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> float:
        """
        Return the minimum resolution of the discretization
        """
        ...

    def nodes(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> drjit.scalar.ArrayXf:
        """
        Return the nodes of the underlying discretization
        """
        ...

    def normalization(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> float:
        """
        Return the normalization factor (i.e. the inverse of sum())
        """
        ...

    def pdf(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> drjit.scalar.ArrayXf:
        """
        Return the unnormalized discretized probability density function
        """
        ...

    def range(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> drjit.scalar.Array2f:
        """
        Return the range of the distribution
        """
        ...

    def sample(self: mitsuba.scalar_spectral.IrregularContinuousDistribution, value: float, active: bool = True) -> float:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_pdf(self: mitsuba.scalar_spectral.IrregularContinuousDistribution, value: float, active: bool = True) -> Tuple[float, float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def size(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> int:
        """
        Return the number of discretizations
        """
        ...

    def update(self: mitsuba.scalar_spectral.IrregularContinuousDistribution) -> None:
        """
...
class MarginalContinuous2D0:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalContinuous2D0, data: numpy.ndarray[numpy.float32], param_values: List[List[float][0]] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalContinuous2D0, pos: drjit.scalar.Array2f, param: drjit.scalar.Array0f = [], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalContinuous2D0, sample: drjit.scalar.Array2f, param: drjit.scalar.Array0f = [], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalContinuous2D0, sample: drjit.scalar.Array2f, param: drjit.scalar.Array0f = [], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D1:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalContinuous2D1, data: numpy.ndarray[numpy.float32], param_values: List[List[float][1]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalContinuous2D1, pos: drjit.scalar.Array2f, param: drjit.scalar.Array1f = [0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalContinuous2D1, sample: drjit.scalar.Array2f, param: drjit.scalar.Array1f = [0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalContinuous2D1, sample: drjit.scalar.Array2f, param: drjit.scalar.Array1f = [0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D2:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalContinuous2D2, data: numpy.ndarray[numpy.float32], param_values: List[List[float][2]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalContinuous2D2, pos: drjit.scalar.Array2f, param: drjit.scalar.Array2f = [0.0, 0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalContinuous2D2, sample: drjit.scalar.Array2f, param: drjit.scalar.Array2f = [0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalContinuous2D2, sample: drjit.scalar.Array2f, param: drjit.scalar.Array2f = [0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D3:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalContinuous2D3, data: numpy.ndarray[numpy.float32], param_values: List[List[float][3]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalContinuous2D3, pos: drjit.scalar.Array2f, param: drjit.scalar.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalContinuous2D3, sample: drjit.scalar.Array2f, param: drjit.scalar.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalContinuous2D3, sample: drjit.scalar.Array2f, param: drjit.scalar.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D0:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalDiscrete2D0, data: numpy.ndarray[numpy.float32], param_values: List[List[float][0]] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalDiscrete2D0, pos: drjit.scalar.Array2f, param: drjit.scalar.Array0f = [], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalDiscrete2D0, sample: drjit.scalar.Array2f, param: drjit.scalar.Array0f = [], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalDiscrete2D0, sample: drjit.scalar.Array2f, param: drjit.scalar.Array0f = [], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D1:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalDiscrete2D1, data: numpy.ndarray[numpy.float32], param_values: List[List[float][1]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalDiscrete2D1, pos: drjit.scalar.Array2f, param: drjit.scalar.Array1f = [0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalDiscrete2D1, sample: drjit.scalar.Array2f, param: drjit.scalar.Array1f = [0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalDiscrete2D1, sample: drjit.scalar.Array2f, param: drjit.scalar.Array1f = [0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D2:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalDiscrete2D2, data: numpy.ndarray[numpy.float32], param_values: List[List[float][2]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalDiscrete2D2, pos: drjit.scalar.Array2f, param: drjit.scalar.Array2f = [0.0, 0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalDiscrete2D2, sample: drjit.scalar.Array2f, param: drjit.scalar.Array2f = [0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalDiscrete2D2, sample: drjit.scalar.Array2f, param: drjit.scalar.Array2f = [0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D3:
    ...
    def __init__(self: mitsuba.scalar_spectral.MarginalDiscrete2D3, data: numpy.ndarray[numpy.float32], param_values: List[List[float][3]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.scalar_spectral.MarginalDiscrete2D3, pos: drjit.scalar.Array2f, param: drjit.scalar.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.scalar_spectral.MarginalDiscrete2D3, sample: drjit.scalar.Array2f, param: drjit.scalar.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.scalar_spectral.MarginalDiscrete2D3, sample: drjit.scalar.Array2f, param: drjit.scalar.Array3f = [0.0, 0.0, 0.0], active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Medium(Object):
    def __init__(self: mitsuba.scalar_spectral.Medium, arg0: mitsuba.Properties) -> None: ...
    ...
    def eval_tr_and_pdf(self: mitsuba.scalar_spectral.Medium, mi, si, active: bool) -> Tuple[mitsuba.scalar_spectral.Spectrum, mitsuba.scalar_spectral.Spectrum]:
        """
    ...
    def get_majorant(self: mitsuba.scalar_spectral.Medium, mi, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
        Returns the medium's majorant used for delta tracking
        """
        ...

    def get_scattering_coefficients(self: mitsuba.scalar_spectral.Medium, mi, active: bool = True) -> Tuple[mitsuba.scalar_spectral.Spectrum, mitsuba.scalar_spectral.Spectrum, mitsuba.scalar_spectral.Spectrum]:
        """
    ...
    def has_spectral_extinction(self: mitsuba.scalar_spectral.Medium) -> bool:
        """
        Returns whether this medium has a spectrally varying extinction
        """
        ...

    def id(self: mitsuba.scalar_spectral.Medium) -> str:
        """
        Return a string identifier
        """
        ...
    ...
    def intersect_aabb(self: mitsuba.scalar_spectral.Medium, ray: mitsuba.scalar_spectral.Ray3f) -> Tuple[bool, float, float]:
        """
        Intersects a ray with the medium's bounding box
        """
        ...

    def is_homogeneous(self: mitsuba.scalar_spectral.Medium) -> bool:
        """
    ...
    def phase_function(self: mitsuba.scalar_spectral.Medium):
        """
    ...
    def sample_interaction(self: mitsuba.scalar_spectral.Medium, ray: mitsuba.scalar_spectral.Ray3f, sample: float, channel: int, active: bool):
        """
    ...
    def use_emitter_sampling(self: mitsuba.scalar_spectral.Medium) -> bool:
        """
...
class MediumInteraction3f(Interaction3f):
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.MediumInteraction3f) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.MediumInteraction3f, arg0: mitsuba.scalar_spectral.MediumInteraction3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def assign(self: mitsuba.scalar_spectral.MediumInteraction3f, arg0: mitsuba.scalar_spectral.MediumInteraction3f) -> None: ...
    def is_valid(self: mitsuba.scalar_spectral.Interaction3f) -> bool:
        """
        Is the current interaction valid?
        """
    ...
    def to_local(self: mitsuba.scalar_spectral.MediumInteraction3f, v: mitsuba.Vector3f) -> mitsuba.Vector3f:
        """
        Convert a world-space vector into local shading coordinates
        """
        ...

    def to_world(self: mitsuba.scalar_spectral.MediumInteraction3f, v: mitsuba.Vector3f) -> mitsuba.Vector3f:
        """
...
class Mesh(Shape):
    @overload
    def __init__(self: mitsuba.scalar_spectral.Mesh, props: mitsuba.Properties) -> None:
        """
        2. __init__(self: mitsuba.scalar_spectral.Mesh, name: str, vertex_count: int, face_count: int, props: mitsuba.scalar_rgb.Properties = Properties[
          plugin_name = "",
          id = "",
          elements = {
          }
    ...
    def add_attribute(self: mitsuba.scalar_spectral.Mesh, name: str, size: int, buffer: List[float]) -> None:
        """
    ...
    @overload
    def bbox(self: mitsuba.scalar_spectral.Shape) -> mitsuba.BoundingBox3f:
        """
    ...
    @overload
    def bbox(self: mitsuba.scalar_spectral.Shape, index: int) -> mitsuba.BoundingBox3f:
        """
    ...
    @overload
    def bbox(self: mitsuba.scalar_spectral.Shape, index: int, clip: mitsuba.BoundingBox3f) -> mitsuba.BoundingBox3f:
        """
    ...
    def bsdf(self: mitsuba.scalar_spectral.Shape):
        """
        Return the shape's BSDF
        """
        ...

    def compute_surface_interaction(self: mitsuba.scalar_spectral.Shape, ray: mitsuba.scalar_spectral.Ray3f, piy_flags: int = 14, active: bool = True):
        """
    ...
    def effective_primitive_count(self: mitsuba.scalar_spectral.Shape) -> int:
        """
    ...
    def emitter(self: mitsuba.scalar_spectral.Shape):
        """
        Return the area emitter associated with this shape (if any)
        """
        ...

    def eval_attribute(self: mitsuba.scalar_spectral.Shape, name: str, si, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
    ...
    def eval_attribute_1(self: mitsuba.scalar_spectral.Shape, name: str, si, active: bool = True) -> float:
        """
    ...
    def eval_attribute_3(self: mitsuba.scalar_spectral.Shape, name: str, si, active: bool = True) -> mitsuba.Color3f:
        """
    ...
    def eval_parameterization(self: mitsuba.scalar_spectral.Mesh, uv: mitsuba.Point2f, ray_flags: int = 14, active: bool = True): ...
    def expand(self: mitsuba.Object) -> list:
        """
        Expand the object into a list of sub-objects and return them
    ...
    def exterior_medium(self: mitsuba.scalar_spectral.Shape):
        """
        Return the medium that lies on the exterior of this shape
        """
        ...

    def face_count(self: mitsuba.scalar_spectral.Mesh) -> int:
        """
        Return the total number of faces
        """
        ...

    def face_indices(self: mitsuba.scalar_spectral.Mesh, index: int, active: bool = True) -> drjit.scalar.Array3u:
        """
        Returns the face indices associated with triangle ``index``
        """
        ...

    def has_vertex_normals(self: mitsuba.scalar_spectral.Mesh) -> bool:
        """
        Does this mesh have per-vertex normals?
        """
        ...

    def has_vertex_texcoords(self: mitsuba.scalar_spectral.Mesh) -> bool:
        """
        Does this mesh have per-vertex texture coordinates?
        """
        ...

    def id(self: mitsuba.scalar_spectral.Shape) -> str:
        """
        Return a string identifier
        """
        ...
    ...
    def initialize(self: mitsuba.scalar_spectral.Mesh) -> None:
        """
        Must be called at the end of the constructor of Mesh plugins
        """
        ...

    def interior_medium(self: mitsuba.scalar_spectral.Shape):
        """
        Return the medium that lies on the interior of this shape
        """
        ...

    def is_emitter(self: mitsuba.scalar_spectral.Shape) -> bool:
        """
        Is this shape also an area emitter?
        """
        ...

    def is_medium_transition(self: mitsuba.scalar_spectral.Shape) -> bool:
        """
        Does the surface of this shape mark a medium transition?
        """
        ...

    def is_mesh(self: mitsuba.scalar_spectral.Shape) -> bool:
        """
        Is this shape a triangle mesh?
        """
        ...

    def is_sensor(self: mitsuba.scalar_spectral.Shape) -> bool:
        """
    ...
    def parameters_grad_enabled(self: mitsuba.scalar_spectral.Shape) -> bool:
        """
    ...
    def pdf_direction(self: mitsuba.scalar_spectral.Shape, it, ps, active: bool = True) -> float:
        """
    ...
    def pdf_position(self: mitsuba.scalar_spectral.Shape, ps, active: bool = True) -> float:
        """
    ...
    def primitive_count(self: mitsuba.scalar_spectral.Shape) -> int:
        """
    ...
    def ray_intersect(self: mitsuba.scalar_spectral.Shape, ray: mitsuba.scalar_spectral.Ray3f, ray_flags: int = 14, active: bool = True):
        """
    ...
    @overload
    def ray_intersect_preliminary(self: mitsuba.scalar_spectral.Shape, ray: mitsuba.scalar_spectral.Ray3f, active: bool = True):
        """
    ...
    def ray_intersect_triangle(self: mitsuba.scalar_spectral.Mesh, index: int, ray: mitsuba.scalar_spectral.Ray3f, active: bool = True): ...
    def ray_test(self: mitsuba.scalar_spectral.Shape, ray: mitsuba.scalar_spectral.Ray3f, active: bool = True) -> bool:
        """
    ...
    def sample_direction(self: mitsuba.scalar_spectral.Shape, it, sample: mitsuba.Point2f, active: bool = True):
        """
    ...
    def sample_position(self: mitsuba.scalar_spectral.Shape, time: float, sample: mitsuba.Point2f, active: bool = True):
        """
    ...
    def sensor(self: mitsuba.scalar_spectral.Shape):
        """
    ...
    def surface_area(self: mitsuba.scalar_spectral.Shape) -> float:
        """
    ...
    def vertex_count(self: mitsuba.scalar_spectral.Mesh) -> int:
        """
        Return the total number of vertices
        """
        ...

    def vertex_normal(self: mitsuba.scalar_spectral.Mesh, index: int, active: bool = True) -> mitsuba.Normal3f:
        """
        Returns the normal direction of the vertex with index ``index``
        """
        ...

    def vertex_position(self: mitsuba.scalar_spectral.Mesh, index: int, active: bool = True) -> mitsuba.Point3f:
        """
        Returns the world-space position of the vertex with index ``index``
        """
        ...

    def vertex_texcoord(self: mitsuba.scalar_spectral.Mesh, index: int, active: bool = True) -> mitsuba.Point2f:
        """
        Returns the UV texture coordinates of the vertex with index ``index``
        """
        ...

    def write_ply(self: mitsuba.scalar_spectral.Mesh, filename: str) -> None:
        """
...
class MicrofacetDistribution:
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha: float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha_u: float, alpha_v: float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha: float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha_u: float, alpha_v: float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.MicrofacetDistribution, arg0: mitsuba.Properties) -> None: ...
    def G(self: mitsuba.scalar_spectral.MicrofacetDistribution, wi: mitsuba.Vector3f, wo: mitsuba.Vector3f, m: mitsuba.Vector3f) -> float:
        """
        Smith's separable shadowing-masking approximation
        """
        ...

    def alpha(self: mitsuba.scalar_spectral.MicrofacetDistribution) -> float:
        """
        Return the roughness (isotropic case)
        """
        ...

    def alpha_u(self: mitsuba.scalar_spectral.MicrofacetDistribution) -> float:
        """
        Return the roughness along the tangent direction
        """
        ...

    def alpha_v(self: mitsuba.scalar_spectral.MicrofacetDistribution) -> float:
        """
        Return the roughness along the bitangent direction
        """
        ...

    def eval(self: mitsuba.scalar_spectral.MicrofacetDistribution, m: mitsuba.Vector3f) -> float:
        """
    ...
    def is_anisotropic(self: mitsuba.scalar_spectral.MicrofacetDistribution) -> bool:
        """
        Is this an anisotropic microfacet distribution?
        """
        ...

    def is_isotropic(self: mitsuba.scalar_spectral.MicrofacetDistribution) -> bool:
        """
        Is this an isotropic microfacet distribution?
        """
        ...

    def pdf(self: mitsuba.scalar_spectral.MicrofacetDistribution, wi: mitsuba.Vector3f, m: mitsuba.Vector3f) -> float:
        """
    ...
    def sample(self: mitsuba.scalar_spectral.MicrofacetDistribution, wi: mitsuba.Vector3f, sample: mitsuba.Point2f) -> Tuple[mitsuba.Normal3f, float]:
        """
    ...
    def sample_visible(self: mitsuba.scalar_spectral.MicrofacetDistribution) -> bool:
        """
        Return whether or not only visible normals are sampled?
        """
        ...

    def sample_visible_11(self: mitsuba.scalar_spectral.MicrofacetDistribution, cos_theta_i: float, sample: mitsuba.Point2f) -> mitsuba.Vector2f:
        """
        Visible normal sampling code for the alpha=1 case
        """
        ...

    def scale_alpha(self: mitsuba.scalar_spectral.MicrofacetDistribution, value: float) -> None:
        """
        Scale the roughness values by some constant
        """
        ...

    def smith_g1(self: mitsuba.scalar_spectral.MicrofacetDistribution, v: mitsuba.Vector3f, m: mitsuba.Vector3f) -> float:
        """
    ...
    def type(self: mitsuba.scalar_spectral.MicrofacetDistribution) -> mitsuba.MicrofacetType:
        """
...
class PhaseFunction(Object):
    def __init__(self: mitsuba.scalar_spectral.PhaseFunction, arg0: mitsuba.Properties) -> None: ...
    m_flags = ...
    ptr = ...

    def component_count(self: mitsuba.scalar_spectral.PhaseFunction, active: bool = True) -> int:
        """
    ...
    def eval(self: mitsuba.scalar_spectral.PhaseFunction, ctx: mitsuba.scalar_spectral.PhaseFunctionContext, mi: mitsuba.scalar_spectral.MediumInteraction3f, wo: mitsuba.Vector3f, active: bool = True) -> float:
        """
    ...
    @overload
    def flags(self: mitsuba.scalar_spectral.PhaseFunction, index: int, active: bool = True) -> int:
        """
    ...
    @overload
    def flags(self: mitsuba.scalar_spectral.PhaseFunction, active: bool = True) -> int:
        """
        Flags for this phase function.
        """
        ...

    def id(self: mitsuba.scalar_spectral.PhaseFunction) -> str:
        """
        Return a string identifier
        """
        ...
    ...
    def max_projected_area(self: mitsuba.scalar_spectral.PhaseFunction) -> float:
        """
    ...
    def projected_area(self: mitsuba.scalar_spectral.PhaseFunction, mi: mitsuba.scalar_spectral.MediumInteraction3f, active: bool = True) -> float:
        """
    ...
    def sample(self: mitsuba.scalar_spectral.PhaseFunction, ctx: mitsuba.scalar_spectral.PhaseFunctionContext, mi: mitsuba.scalar_spectral.MediumInteraction3f, sample1: float, sample2: mitsuba.Point2f, active: bool = True) -> Tuple[mitsuba.Vector3f, float]:
        """
...
class PhaseFunctionContext:
    def __init__(self: mitsuba.scalar_spectral.PhaseFunctionContext, sampler, mode: mitsuba.TransportMode = <TransportMode.Radiance: 0>) -> None:
        """
        //! @}
        """
        ...
    ...
    def reverse(self: mitsuba.scalar_spectral.PhaseFunctionContext) -> None:
        """
        Reverse the direction of light transport in the record
...
class PositionSample3f:
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.PositionSample3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.PositionSample3f, other: mitsuba.scalar_spectral.PositionSample3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.PositionSample3f, si: mitsuba.scalar_spectral.SurfaceInteraction3f) -> None:
        """
        Create a position sampling record from a surface intersection
    ...
    def assign(self: mitsuba.scalar_spectral.PositionSample3f, arg0: mitsuba.scalar_spectral.PositionSample3f) -> None: ...
    ...
...
class PreliminaryIntersection3f:
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.PreliminaryIntersection3f) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.PreliminaryIntersection3f, arg0: mitsuba.scalar_spectral.PreliminaryIntersection3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def assign(self: mitsuba.scalar_spectral.PreliminaryIntersection3f, arg0: mitsuba.scalar_spectral.PreliminaryIntersection3f) -> None: ...
    def compute_surface_interaction(self: mitsuba.scalar_spectral.PreliminaryIntersection3f, ray: mitsuba.scalar_spectral.Ray3f, ray_flags: int = 14, active: bool = True) -> mitsuba.scalar_spectral.SurfaceInteraction3f:
        """
        Compute and return detailed information related to a surface
        interaction
    ...
    def is_valid(self: mitsuba.scalar_spectral.PreliminaryIntersection3f) -> bool:
        """
        Is the current interaction valid?
        """
        ...
...
class ProjectiveCamera(Sensor):
    ...
    def far_clip(self: mitsuba.scalar_spectral.ProjectiveCamera) -> float:
        """
        Return the far clip plane distance
        """
        ...

    def film(self: mitsuba.scalar_spectral.Sensor) -> mitsuba.scalar_spectral.Film:
        """
        Return the Film instance associated with this sensor
        """
        ...

    def focus_distance(self: mitsuba.scalar_spectral.ProjectiveCamera) -> float:
        """
    ...
    def near_clip(self: mitsuba.scalar_spectral.ProjectiveCamera) -> float:
        """
        Return the near clip plane distance
        """
        ...

    def needs_aperture_sample(self: mitsuba.scalar_spectral.Sensor) -> bool:
        """
    ...
    def sample_ray_differential(self: mitsuba.scalar_spectral.Sensor, time: float, sample1: float, sample2: mitsuba.Point2f, sample3: mitsuba.Point2f, active: bool = True) -> Tuple[mitsuba.scalar_spectral.RayDifferential3f, mitsuba.scalar_spectral.Spectrum]: ...
    def sample_wavelengths(self: mitsuba.scalar_spectral.Endpoint, si, sample: float, active: bool = True) -> Tuple[mitsuba.scalar_spectral.Spectrum, mitsuba.scalar_spectral.Spectrum]:
        """
        Importance sample a set of wavelengths according to the endpoint's
        sensitivity/emission spectrum.
    ...
    def sampler(self: mitsuba.scalar_spectral.Sensor) -> mitsuba.scalar_spectral.Sampler:
        """
    ...
    def shutter_open(self: mitsuba.scalar_spectral.Sensor) -> float:
        """
        Return the time value of the shutter opening event
        """
        ...

    def shutter_open_time(self: mitsuba.scalar_spectral.Sensor) -> float:
        """
...
class RadicalInverse(Object):
    ...
    def __init__(self: mitsuba.scalar_spectral.RadicalInverse, max_base: int = 8161, scramble: int = -1) -> None: ...
    ptr = ...

    def base(self: mitsuba.scalar_spectral.RadicalInverse, arg0: int) -> int:
        """
    ...
    def bases(self: mitsuba.scalar_spectral.RadicalInverse) -> int:
        """
    ...
    def eval(self: mitsuba.scalar_spectral.RadicalInverse, base_index: int, index: int) -> float:
        """
    ...
    def inverse_permutation(self: mitsuba.scalar_spectral.RadicalInverse, arg0: int) -> int:
        """
    ...
    def scramble(self: mitsuba.scalar_spectral.RadicalInverse) -> int:
        """
...
class Ray2f:
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Ray2f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Ray2f, other: mitsuba.scalar_spectral.Ray2f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Ray2f, o: mitsuba.Point2f, d: mitsuba.Vector2f, time: float = 0.0, wavelengths: mitsuba.scalar_spectral.Spectrum = [0.0, 0.0, 0.0, 0.0]) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Ray2f, o: mitsuba.Point2f, d: mitsuba.Vector2f, maxt: float, time: float, wavelengths: mitsuba.scalar_spectral.Spectrum) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Ray2f, other: mitsuba.scalar_spectral.Ray2f, maxt: float) -> None: ...
    def __call__(self: mitsuba.scalar_spectral.Ray2f, t: float) -> mitsuba.Point2f:
        """
    ...
    def assign(self: mitsuba.scalar_spectral.Ray2f, arg0: mitsuba.scalar_spectral.Ray2f) -> None: ...
    ...
...
class Ray3f:
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Ray3f) -> None:
        """
        Create an uninitialized ray
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Ray3f, other: mitsuba.scalar_spectral.Ray3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Ray3f, o: mitsuba.Point3f, d: mitsuba.Vector3f, time: float = 0.0, wavelengths: mitsuba.scalar_spectral.Spectrum = [0.0, 0.0, 0.0, 0.0]) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Ray3f, o: mitsuba.Point3f, d: mitsuba.Vector3f, maxt: float, time: float, wavelengths: mitsuba.scalar_spectral.Spectrum) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.Ray3f, other: mitsuba.scalar_spectral.Ray3f, maxt: float) -> None: ...
    def __call__(self: mitsuba.scalar_spectral.Ray3f, t: float) -> mitsuba.Point3f:
        """
        Return the position of a point along the ray
        """
        ...
    ...
    def assign(self: mitsuba.scalar_spectral.Ray3f, arg0: mitsuba.scalar_spectral.Ray3f) -> None: ...
    ...
...
class RayDifferential3f(Ray3f):
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.RayDifferential3f) -> None:
        """
        Create an uninitialized ray
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.RayDifferential3f, ray: mitsuba.scalar_spectral.Ray3f) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.RayDifferential3f, o: mitsuba.Point3f, d: mitsuba.Vector3f, time: float = 0.0, wavelengths: mitsuba.scalar_spectral.Spectrum = [0.0, 0.0, 0.0, 0.0]) -> None:
        """
    ...
    def assign(self: mitsuba.scalar_spectral.RayDifferential3f, arg0: mitsuba.scalar_spectral.RayDifferential3f) -> None: ...
    def scale_differential(self: mitsuba.scalar_spectral.RayDifferential3f, amount: float) -> None: ...
    ...
...
class ReconstructionFilter(Object):
    ...
    def border_size(self: mitsuba.scalar_spectral.ReconstructionFilter) -> int:
        """
        Return the block border size required when rendering with this filter
        """
        ...
    ...
    def eval(self: mitsuba.scalar_spectral.ReconstructionFilter, x: float, active: bool = True) -> float:
        """
        Evaluate the filter function
        """
        ...

    def eval_discretized(self: mitsuba.scalar_spectral.ReconstructionFilter, x: float, active: bool = True) -> float:
        """
        Evaluate a discretized version of the filter (generally faster than
        'eval')
        """
    ...
    def is_box_filter(self: mitsuba.scalar_spectral.ReconstructionFilter) -> bool:
        """
        Check whether this is a box filter?
        """
        ...
    ...
    def radius(self: mitsuba.scalar_spectral.ReconstructionFilter) -> float:
        """
        Return the filter's width
        """
        ...
...
class Sampler(Object):
    ...
    def __init__(self: mitsuba.scalar_spectral.Sampler, props: mitsuba.Properties) -> None: ...
    ptr = ...

    def advance(self: mitsuba.scalar_spectral.Sampler) -> None:
        """
    ...
    def clone(self: mitsuba.scalar_spectral.Sampler) -> mitsuba.scalar_spectral.Sampler:
        """
    ...
    def fork(self: mitsuba.scalar_spectral.Sampler) -> mitsuba.scalar_spectral.Sampler:
        """
    ...
    def loop_put(self: mitsuba.scalar_spectral.Sampler, loop) -> None:
        """
        Register internal state of this sampler with a symbolic loop
        """
        ...

    def next_1d(self: mitsuba.scalar_spectral.Sampler, active: bool = True) -> float:
        """
        Retrieve the next component value from the current sample
        """
        ...

    def next_2d(self: mitsuba.scalar_spectral.Sampler, active: bool = True) -> mitsuba.Point2f:
        """
    ...
    def sample_count(self: mitsuba.scalar_spectral.Sampler) -> int:
        """
        Return the number of samples per pixel
        """
        ...

    def schedule_state(self: mitsuba.scalar_spectral.Sampler) -> None:
        """
        dr::schedule() variables that represent the internal sampler state
        """
        ...

    def seed(self: mitsuba.scalar_spectral.Sampler, seed: int, wavefront_size: int = 4294967295) -> None:
        """
    ...
    def set_sample_count(self: mitsuba.scalar_spectral.Sampler, spp: int) -> None:
        """
        Set the number of samples per pixel
        """
        ...

    def set_samples_per_wavefront(self: mitsuba.scalar_spectral.Sampler, samples_per_wavefront: int) -> None:
        """
    ...
    def wavefront_size(self: mitsuba.scalar_spectral.Sampler) -> int:
        """
...
class SamplingIntegrator(Integrator):
    ...
    def __init__(self: mitsuba.scalar_spectral.SamplingIntegrator, arg0: mitsuba.Properties) -> None: ...
    ptr = ...
...
class Scene(Object):
    ...
    * Sampling directions approximately proportional to the direct
    ...
    def __init__(self: mitsuba.scalar_spectral.Scene, arg0: mitsuba.Properties) -> None: ...
    ptr = ...

    def bbox(self: mitsuba.scalar_spectral.Scene) -> mitsuba.BoundingBox3f:
        """
    ...
    def emitters(self: mitsuba.scalar_spectral.Scene):
        """
        Return the list of emitters
        """
        ...

    def emitters_dr(self: mitsuba.scalar_spectral.Scene):
        """
        Return the list of emitters as an Dr.Jit array
        """
        ...

    def environment(self: mitsuba.scalar_spectral.Scene):
        """
        Return the environment emitter (if any)
        """
        ...

    def eval_emitter_direction(self: mitsuba.scalar_spectral.Scene, ref, ds, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
    ...
    def integrator(self: mitsuba.scalar_spectral.Scene) -> object:
        """
    ...
    def pdf_emitter(self: mitsuba.scalar_spectral.Scene, index: int, active: bool = True) -> float:
        """
    ...
    def pdf_emitter_direction(self: mitsuba.scalar_spectral.Scene, ref, ds, active: bool = True) -> float:
        """
    ...
    @overload
    def ray_intersect(self: mitsuba.scalar_spectral.Scene, ray: mitsuba.scalar_spectral.Ray3f, active: bool = True):
        """
    ...
    @overload
    def ray_intersect(self: mitsuba.scalar_spectral.Scene, ray: mitsuba.scalar_spectral.Ray3f, ray_flags: int, coherent: bool, active: bool = True):
        """
        Intersect a ray with the shapes comprising the scene and return a
        detailed data structure describing the intersection, if one is found
    ...
    def ray_intersect_preliminary(self: mitsuba.scalar_spectral.Scene, ray: mitsuba.scalar_spectral.Ray3f, coherent: bool = False, active: bool = True):
        """
    ...
    @overload
    def ray_test(self: mitsuba.scalar_spectral.Scene, ray: mitsuba.scalar_spectral.Ray3f, active: bool = True) -> bool:
        """
        Intersect a ray with the shapes comprising the scene and return a
    ...
    @overload
    def ray_test(self: mitsuba.scalar_spectral.Scene, ray: mitsuba.scalar_spectral.Ray3f, coherent: bool, active: bool = True) -> bool:
        """
        Intersect a ray with the shapes comprising the scene and return a
        boolean specifying whether or not an intersection was found.
    ...
    def sample_emitter(self: mitsuba.scalar_spectral.Scene, sample: float, active: bool = True) -> Tuple[int, float, float]:
        """
    ...
    def sample_emitter_direction(self: mitsuba.scalar_spectral.Scene, ref, sample: mitsuba.Point2f, test_visibility: bool = True, active: bool = True):
        """
    ...
    def sensors(self: mitsuba.scalar_spectral.Scene):
        """
    ...
    def shapes(self: mitsuba.scalar_spectral.Scene) -> list:
        """
        Return the list of shapes
        """
        ...

    def shapes_dr(self: mitsuba.scalar_spectral.Scene):
        """
        Return the list of shapes as an Dr.Jit array
        """
        ...

    def shapes_grad_enabled(self: mitsuba.scalar_spectral.Scene) -> bool:
        """
...
class Sensor(Endpoint):
    def __init__(self: mitsuba.scalar_spectral.Sensor, arg0: mitsuba.Properties) -> None: ...
    m_needs_sample_2 = ...
    m_needs_sample_3 = ...
    ptr = ...
...
from drjit.scalar import Array4f
class Spectrum(Array4f):
    def __init__(self: mitsuba.scalar_spectral.Spectrum, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
class SurfaceInteraction3f(Interaction3f):
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.SurfaceInteraction3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.SurfaceInteraction3f, arg0: mitsuba.scalar_spectral.SurfaceInteraction3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.SurfaceInteraction3f, ps, wavelengths: mitsuba.scalar_spectral.Spectrum) -> None:
        """
        Construct from a position sample. Unavailable fields such as `wi` and
        the partial derivatives are left uninitialized. The `shape` pointer is
        left uninitialized because we can't guarantee that the given
    ...
    def assign(self: mitsuba.scalar_spectral.SurfaceInteraction3f, arg0: mitsuba.scalar_spectral.SurfaceInteraction3f) -> None: ...
    @overload
    def bsdf(self: mitsuba.scalar_spectral.SurfaceInteraction3f, ray: mitsuba.scalar_spectral.RayDifferential3f):
        """
    ...
    @overload
    def bsdf(self: mitsuba.scalar_spectral.SurfaceInteraction3f): ...
    def compute_uv_partials(self: mitsuba.scalar_spectral.SurfaceInteraction3f, ray: mitsuba.scalar_spectral.RayDifferential3f) -> None:
        """
        Computes texture coordinate partials
        """
        ...

    def emitter(self: mitsuba.scalar_spectral.SurfaceInteraction3f, scene: mitsuba.scalar_spectral.Scene, active: bool = True) -> mitsuba.scalar_spectral.Emitter:
        """
    ...
    def has_n_partials(self: mitsuba.scalar_spectral.SurfaceInteraction3f) -> bool: ...
    def has_uv_partials(self: mitsuba.scalar_spectral.SurfaceInteraction3f) -> bool: ...
    def initialize_sh_frame(self: mitsuba.scalar_spectral.SurfaceInteraction3f) -> None:
        """
        Initialize local shading frame using Gram-schmidt orthogonalization
        """
        ...

    def is_medium_transition(self: mitsuba.scalar_spectral.SurfaceInteraction3f) -> bool:
        """
        Does the surface mark a transition between two media?
        """
        ...

    def is_sensor(self: mitsuba.scalar_spectral.SurfaceInteraction3f) -> bool:
        """
    ...
    @overload
    def target_medium(self: mitsuba.scalar_spectral.SurfaceInteraction3f, d: mitsuba.Vector3f) -> mitsuba.scalar_spectral.Medium:
        """
    ...
    @overload
    def target_medium(self: mitsuba.scalar_spectral.SurfaceInteraction3f, cos_theta: float) -> mitsuba.scalar_spectral.Medium:
        """
    ...
    def to_local(self: mitsuba.scalar_spectral.SurfaceInteraction3f, v: mitsuba.Vector3f) -> mitsuba.Vector3f:
        """
        Convert a world-space vector into local shading coordinates
        """
        ...

    def to_local_mueller(self: mitsuba.scalar_spectral.SurfaceInteraction3f, M_world: mitsuba.scalar_spectral.Spectrum, wi_world: mitsuba.Vector3f, wo_world: mitsuba.Vector3f) -> mitsuba.scalar_spectral.Spectrum:
        """
    ...
    def to_world(self: mitsuba.scalar_spectral.SurfaceInteraction3f, v: mitsuba.Vector3f) -> mitsuba.Vector3f:
        """
        Convert a local shading-space vector into world space
        """
        ...

    def to_world_mueller(self: mitsuba.scalar_spectral.SurfaceInteraction3f, M_local: mitsuba.scalar_spectral.Spectrum, wi_local: mitsuba.Vector3f, wo_local: mitsuba.Vector3f) -> mitsuba.scalar_spectral.Spectrum:
        """
...
class Texture(Object):
    ...
    def __init__(self: mitsuba.scalar_spectral.Texture, props: mitsuba.Properties) -> None: ...
    ptr = ...
    ...
    def eval(self: mitsuba.scalar_spectral.Texture, si: mitsuba.scalar_spectral.SurfaceInteraction3f, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
    ...
    def eval_1(self: mitsuba.scalar_spectral.Texture, si: mitsuba.scalar_spectral.SurfaceInteraction3f, active: bool = True) -> float:
        """
    ...
    def eval_1_grad(self: mitsuba.scalar_spectral.Texture, si: mitsuba.scalar_spectral.SurfaceInteraction3f, active: bool = True) -> mitsuba.Vector2f:
        """
    ...
    def eval_3(self: mitsuba.scalar_spectral.Texture, si: mitsuba.scalar_spectral.SurfaceInteraction3f, active: bool = True) -> mitsuba.Color3f:
        """
    ...
    def is_spatially_varying(self: mitsuba.scalar_spectral.Texture) -> bool:
        """
        Does this texture evaluation depend on the UV coordinates
        """
        ...

    def max(self: mitsuba.scalar_spectral.Texture) -> float:
        """
    ...
    def mean(self: mitsuba.scalar_spectral.Texture) -> float:
        """
    ...
    def pdf_position(self: mitsuba.scalar_spectral.Texture, p: mitsuba.Point2f, active: bool = True) -> float:
        """
        Returns the probability per unit area of sample_position()
        """
        ...

    def pdf_spectrum(self: mitsuba.scalar_spectral.Texture, si: mitsuba.scalar_spectral.SurfaceInteraction3f, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
    ...
    def resolution(self: mitsuba.scalar_spectral.Texture) -> mitsuba.Vector2i:
        """
    ...
    def sample_position(self: mitsuba.scalar_spectral.Texture, sample: mitsuba.Point2f, active: bool = True) -> Tuple[mitsuba.Point2f, float]:
        """
    ...
    def sample_spectrum(self: mitsuba.scalar_spectral.Texture, si: mitsuba.scalar_spectral.SurfaceInteraction3f, sample: mitsuba.scalar_spectral.Spectrum, active: bool = True) -> Tuple[mitsuba.scalar_spectral.Spectrum, mitsuba.scalar_spectral.Spectrum]:
        """
    ...
    def spectral_resolution(self: mitsuba.scalar_spectral.Texture) -> float:
        """
    ...
    def wavelength_range(self: mitsuba.scalar_spectral.Texture) -> mitsuba.Vector2f:
        """
...
class Volume(Object):
    ...
    def bbox(self: mitsuba.scalar_spectral.Volume) -> mitsuba.BoundingBox3f:
        """
        Returns the bounding box of the volume
        """
        ...

    def channel_count(self: mitsuba.scalar_spectral.Volume) -> int:
        """
    ...
    def eval(self: mitsuba.scalar_spectral.Volume, it: mitsuba.scalar_spectral.Interaction3f, active: bool = True) -> mitsuba.scalar_spectral.Spectrum:
        """
    ...
    def eval_1(self: mitsuba.scalar_spectral.Volume, it: mitsuba.scalar_spectral.Interaction3f, active: bool = True) -> float:
        """
        Evaluate this volume as a single-channel quantity.
        """
        ...

    def eval_3(self: mitsuba.scalar_spectral.Volume, it: mitsuba.scalar_spectral.Interaction3f, active: bool = True) -> mitsuba.Vector3f:
        """
    ...
    def eval_6(self: mitsuba.scalar_spectral.Volume, it: mitsuba.scalar_spectral.Interaction3f, active: bool = True) -> List[float[6]]:
        """
    ...
    def eval_gradient(self: mitsuba.scalar_spectral.Volume, it: mitsuba.scalar_spectral.Interaction3f, active: bool = True) -> Tuple[mitsuba.scalar_spectral.Spectrum, mitsuba.Vector3f]:
        """
    ...
    def eval_n(self: mitsuba.scalar_spectral.Volume, it: mitsuba.scalar_spectral.Interaction3f, active: bool = True) -> List[float]:
        """
    ...
    def max(self: mitsuba.scalar_spectral.Volume) -> float:
        """
        Returns the maximum value of the volume over all dimensions.
        """
        ...

    def max_per_channel(self: mitsuba.scalar_spectral.Volume) -> List[float]:
        """
    ...
    def resolution(self: mitsuba.scalar_spectral.Volume) -> mitsuba.Vector3i:
        """
...
class VolumeGrid(Object):
    @overload
    def __init__(self: mitsuba.scalar_spectral.VolumeGrid, array: numpy.ndarray[numpy.float32], compute_max: bool = True) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.VolumeGrid, path: mitsuba.filesystem.path) -> None: ...
    @overload
    def __init__(self: mitsuba.scalar_spectral.VolumeGrid, stream: mitsuba.Stream) -> None: ...
    ptr = ...

    def buffer_size(self: mitsuba.scalar_spectral.VolumeGrid) -> int:
        """
        Return the volume grid size in bytes (excluding metadata)
        """
        ...

    def bytes_per_voxel(self: mitsuba.scalar_spectral.VolumeGrid) -> int:
        """
        Return the number bytes of storage used per voxel
        """
        ...

    def channel_count(self: mitsuba.scalar_spectral.VolumeGrid) -> int:
        """
    ...
    def max(self: mitsuba.scalar_spectral.VolumeGrid) -> float:
        """
        Return the precomputed maximum over the volume grid
        """
        ...

    def max_per_channel(self: mitsuba.scalar_spectral.VolumeGrid) -> List[float]:
        """
    ...
    def set_max(self: mitsuba.scalar_spectral.VolumeGrid, arg0: float) -> None:
        """
        Set the precomputed maximum over the volume grid
        """
        ...

    def set_max_per_channel(self: mitsuba.scalar_spectral.VolumeGrid, arg0: List[float]) -> None:
        """
    ...
    def size(self: mitsuba.scalar_spectral.VolumeGrid) -> mitsuba.Vector3u:
        """
    ...
    @overload
    def write(self: mitsuba.scalar_spectral.VolumeGrid, stream: mitsuba.Stream) -> None:
        """
    ...
    @overload
    def write(self: mitsuba.scalar_spectral.VolumeGrid, path: mitsuba.filesystem.path) -> None:
        """
...
def depolarizer(arg0: mitsuba.scalar_spectral.Spectrum) -> mitsuba.scalar_spectral.Spectrum: ...
...
@overload
def luminance(value: mitsuba.scalar_spectral.Spectrum, wavelengths: mitsuba.scalar_spectral.Spectrum, active: bool = True) -> float: ...
@overload
...
@overload
def pdf_rgb_spectrum(wavelengths: mitsuba.scalar_spectral.Spectrum) -> mitsuba.scalar_spectral.Spectrum:
    """
    PDF for the sample_rgb_spectrum strategy. It is valid to call this
    function for a single wavelength (Float), a set of wavelengths
    (Spectrumf), a packet of wavelengths (SpectrumfP), etc. In all cases,
...
@overload
def sample_rgb_spectrum(sample: mitsuba.scalar_spectral.Spectrum) -> Tuple[mitsuba.scalar_spectral.Spectrum, mitsuba.scalar_spectral.Spectrum]:
    """
    Importance sample a "importance spectrum" that concentrates the
    computation on wavelengths that are relevant for rendering of RGB data
...
def sample_shifted(sample: float) -> drjit.scalar.Array4f: ...
...
def spectrum_to_srgb(value: mitsuba.scalar_spectral.Spectrum, wavelengths: mitsuba.scalar_spectral.Spectrum, active: bool = True) -> mitsuba.Color3f:
    """
    Spectral responses to sRGB.
    """
    ...

def spectrum_to_xyz(value: mitsuba.scalar_spectral.Spectrum, wavelengths: mitsuba.scalar_spectral.Spectrum, active: bool = True) -> mitsuba.Color3f:
    """
...
def srgb_model_eval(arg0: drjit.scalar.Array3f, arg1: mitsuba.scalar_spectral.Spectrum) -> mitsuba.scalar_spectral.Spectrum: ...
...
def unpolarized_spectrum(arg0: mitsuba.scalar_spectral.Spectrum) -> mitsuba.scalar_spectral.Spectrum: ...
