...
####Inputs
def open_area(simulator_path):
    WI_coordinates_file = "../../Richard_coords/opposite_lane_200_points_withHeights.csv"   ### we can assume it happend there
    mat_file = "../talon-sector-patterns-master/talon-sector-patterns-master/legacy_measurements/sectorpattern_3d_sta.mat"
    # flash = "/Users/maryam/Desktop/digital_twin_flash/flash/Cat3/static_in_front/Extract/"
    flash_files = ["../../flash/flash/Cat1/opposite/Extract",
                "../../flash/flash/Cat3/static_in_front/Extract"]
    open_area_files = [simulator_path + "Twin-1_LOS.csv",
                        simulator_path + "Twin-1_NLOS.csv"
        ]
    ...
    for thershold in range (0, 3):
        ...
        averages = []
        ####extract powers
        for open_area in open_area_files:
            ...
            averages.append(sum(prob_per_csv)/len(prob_per_csv))
    # print(f'All averages ([Twin-1 LOS, Twin-1 NLOS]): {averages}')
        ave_thresh.append(averages)
    return ave_thresh