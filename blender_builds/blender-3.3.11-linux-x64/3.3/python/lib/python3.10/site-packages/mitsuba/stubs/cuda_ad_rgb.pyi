...
class AdjointIntegrator(Integrator):
    ...
    def aov_names(self: mitsuba.cuda_ad_rgb.Integrator) -> List[str]:
        """
    ...
    def cancel(self: mitsuba.cuda_ad_rgb.Integrator) -> None:
        """
    ...
    @overload
    def render(self: mitsuba.cuda_ad_rgb.Integrator, scene: mitsuba.cuda_ad_rgb.Scene, sensor, seed: int = 0, spp: int = 0, develop: bool = True, evaluate: bool = True) -> drjit.cuda.ad.TensorXf:
        """
        Render the scene
    ...
    @overload
    def render(self: mitsuba.cuda_ad_rgb.Integrator, scene: mitsuba.cuda_ad_rgb.Scene, sensor: int = 0, seed: int = 0, spp: int = 0, develop: bool = True, evaluate: bool = True) -> drjit.cuda.ad.TensorXf:
        """
        Render the scene
    ...
    def sample(self: mitsuba.cuda_ad_rgb.AdjointIntegrator, scene: mitsuba.cuda_ad_rgb.Scene, sensor, sampler, block: mitsuba.cuda_ad_rgb.ImageBlock, sample_scale: float) -> None:
        """
    ...
    def should_stop(self: mitsuba.cuda_ad_rgb.Integrator) -> bool:
        """
...
class BSDF(Object):
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.BSDF, props: mitsuba.Properties) -> None: ...
    m_components = ...
    m_flags = ...
    ptr = ...

    def component_count(self: mitsuba.cuda_ad_rgb.BSDF, active: drjit.cuda.ad.Bool = True) -> int:
        """
    ...
    def eval(self: mitsuba.cuda_ad_rgb.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_null_transmission(self: mitsuba.cuda_ad_rgb.BSDF, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_pdf(self: mitsuba.cuda_ad_rgb.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, drjit.cuda.ad.Float]:
        """
    ...
    @overload
    def flags(self: mitsuba.cuda_ad_rgb.BSDF, index: int, active: drjit.cuda.ad.Bool = True) -> int:
        """
    ...
    @overload
    def flags(self: mitsuba.cuda_ad_rgb.BSDF) -> int:
        """
        Flags for all components combined.
        """
        ...

    def id(self: mitsuba.cuda_ad_rgb.BSDF) -> str:
        """
    ...
    def needs_differentials(self: mitsuba.cuda_ad_rgb.BSDF) -> bool:
        """
    ...
    def pdf(self: mitsuba.cuda_ad_rgb.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def sample(self: mitsuba.cuda_ad_rgb.BSDF, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, sample1: drjit.cuda.ad.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.BSDFSample3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
...
class BSDFPtr(ArrayBase):
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BSDFPtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BSDFPtr, arg0: mitsuba.cuda_ad_rgb.BSDF) -> None: ...
    index = ...
    label = ...

    def assign(self: mitsuba.cuda_ad_rgb.BSDFPtr, arg0: mitsuba.cuda_ad_rgb.BSDFPtr) -> None: ...
    def eval(self: mitsuba.cuda_ad_rgb.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Evaluate the BSDF f(wi, wo) or its adjoint version f^{*}(wi, wo) and
        multiply by the cosine foreshortening term.
    ...
    def eval_null_transmission(self: mitsuba.cuda_ad_rgb.BSDFPtr, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Evaluate un-scattered transmission component of the BSDF
    ...
    def eval_pdf(self: mitsuba.cuda_ad_rgb.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, drjit.cuda.ad.Float]:
        """
        Jointly evaluate the BSDF f(wi, wo) and the probability per unit solid
        angle of sampling the given direction. The result from the evaluated
        BSDF is multiplied by the cosine foreshortening term.
    ...
    def flags(self: mitsuba.cuda_ad_rgb.BSDFPtr) -> drjit.cuda.ad.UInt:
        """
        Flags for all components combined.
        """
        ...

    def needs_differentials(self: mitsuba.cuda_ad_rgb.BSDFPtr) -> drjit.cuda.ad.Bool:
        """
        Does the implementation require access to texture-space differentials?
        """
        ...

    def pdf(self: mitsuba.cuda_ad_rgb.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Compute the probability per unit solid angle of sampling a given
        direction
    ...
    def sample(self: mitsuba.cuda_ad_rgb.BSDFPtr, ctx: mitsuba.BSDFContext, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, sample1: drjit.cuda.ad.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.BSDFSample3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample the BSDF model
...
class BSDFSample3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BSDFSample3f) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BSDFSample3f, wo: mitsuba.cuda_ad_rgb.Vector3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BSDFSample3f, bs: mitsuba.cuda_ad_rgb.BSDFSample3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def assign(self: mitsuba.cuda_ad_rgb.BSDFSample3f, arg0: mitsuba.cuda_ad_rgb.BSDFSample3f) -> None: ...
    ...
...
class BoundingBox2f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BoundingBox2f, p: mitsuba.cuda_ad_rgb.Point2f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BoundingBox2f, min: mitsuba.cuda_ad_rgb.Point2f, max: mitsuba.cuda_ad_rgb.Point2f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BoundingBox2f, arg0: mitsuba.cuda_ad_rgb.BoundingBox2f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def center(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> mitsuba.cuda_ad_rgb.Point2f:
        """
        Return the center point
        """
        ...

    def clip(self: mitsuba.cuda_ad_rgb.BoundingBox2f, arg0: mitsuba.cuda_ad_rgb.BoundingBox2f) -> None:
        """
        Clip this bounding box to another bounding box
        """
        ...

    def collapsed(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> drjit.cuda.ad.Bool:
        """
    ...
    @overload
    def contains(self: mitsuba.cuda_ad_rgb.BoundingBox2f, p: mitsuba.cuda_ad_rgb.Point2f, strict: bool = False) -> drjit.cuda.ad.Bool:
        """
    ...
    @overload
    def contains(self: mitsuba.cuda_ad_rgb.BoundingBox2f, bbox: mitsuba.cuda_ad_rgb.BoundingBox2f, strict: bool = False) -> drjit.cuda.ad.Bool:
        """
    ...
    def corner(self: mitsuba.cuda_ad_rgb.BoundingBox2f, arg0: int) -> mitsuba.cuda_ad_rgb.Point2f:
        """
    ...
    @overload
    def distance(self: mitsuba.cuda_ad_rgb.BoundingBox2f, arg0: mitsuba.cuda_ad_rgb.Point2f) -> drjit.cuda.ad.Float:
        """
    ...
    @overload
    def distance(self: mitsuba.cuda_ad_rgb.BoundingBox2f, arg0: mitsuba.cuda_ad_rgb.BoundingBox2f) -> drjit.cuda.ad.Float:
        """
        Calculate the shortest distance between the axis-aligned bounding box
        and ``bbox``.
        """
    ...
    @overload
    def expand(self: mitsuba.cuda_ad_rgb.BoundingBox2f, arg0: mitsuba.cuda_ad_rgb.Point2f) -> None:
        """
    ...
    @overload
    def expand(self: mitsuba.cuda_ad_rgb.BoundingBox2f, arg0: mitsuba.cuda_ad_rgb.BoundingBox2f) -> None:
        """
        Expand the bounding box to contain another bounding box
        """
        ...

    def extents(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> mitsuba.cuda_ad_rgb.Vector2f:
        """
    ...
    def major_axis(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> drjit.cuda.ad.UInt:
        """
        Return the dimension index with the index associated side length
        """
        ...

    def minor_axis(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> drjit.cuda.ad.UInt:
        """
        Return the dimension index with the shortest associated side length
        """
        ...

    def overlaps(self: mitsuba.cuda_ad_rgb.BoundingBox2f, bbox: mitsuba.cuda_ad_rgb.BoundingBox2f, strict: bool = False) -> drjit.cuda.ad.Bool:
        """
    ...
    def reset(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> None:
        """
    ...
    @overload
    def squared_distance(self: mitsuba.cuda_ad_rgb.BoundingBox2f, arg0: mitsuba.cuda_ad_rgb.Point2f) -> drjit.cuda.ad.Float:
        """
    ...
    @overload
    def squared_distance(self: mitsuba.cuda_ad_rgb.BoundingBox2f, arg0: mitsuba.cuda_ad_rgb.BoundingBox2f) -> drjit.cuda.ad.Float:
        """
        Calculate the shortest squared distance between the axis-aligned
    ...
    def surface_area(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> drjit.cuda.ad.Float:
        """
        Calculate the 2-dimensional surface area of a 3D bounding box
        """
        ...

    def valid(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> drjit.cuda.ad.Bool:
        """
    ...
    def volume(self: mitsuba.cuda_ad_rgb.BoundingBox2f) -> drjit.cuda.ad.Float:
        """
...
class BoundingBox3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> None:
        """
        Create a new invalid bounding box
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BoundingBox3f, p: mitsuba.cuda_ad_rgb.Point3f) -> None:
        """
        Create a collapsed bounding box from a single point
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BoundingBox3f, min: mitsuba.cuda_ad_rgb.Point3f, max: mitsuba.cuda_ad_rgb.Point3f) -> None:
        """
        Create a bounding box from two positions
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BoundingBox3f, arg0: mitsuba.cuda_ad_rgb.BoundingBox3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def bounding_sphere(self: mitsuba.cuda_ad_rgb.BoundingBox3f):
        """
        Create a bounding sphere, which contains the axis-aligned box
        """
        ...

    def center(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> mitsuba.cuda_ad_rgb.Point3f:
        """
        Return the center point
        """
        ...

    def clip(self: mitsuba.cuda_ad_rgb.BoundingBox3f, arg0: mitsuba.cuda_ad_rgb.BoundingBox3f) -> None:
        """
        Clip this bounding box to another bounding box
        """
        ...

    def collapsed(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> drjit.cuda.ad.Bool:
        """
        Check whether this bounding box has collapsed to a point, line, or
        plane
        """
    ...
    @overload
    def contains(self: mitsuba.cuda_ad_rgb.BoundingBox3f, p: mitsuba.cuda_ad_rgb.Point3f, strict: bool = False) -> drjit.cuda.ad.Bool:
        """
        Check whether a point lies *on* or *inside* the bounding box
    ...
    @overload
    def contains(self: mitsuba.cuda_ad_rgb.BoundingBox3f, bbox: mitsuba.cuda_ad_rgb.BoundingBox3f, strict: bool = False) -> drjit.cuda.ad.Bool:
        """
        Check whether a specified bounding box lies *on* or *within* the
        current bounding box
    ...
    def corner(self: mitsuba.cuda_ad_rgb.BoundingBox3f, arg0: int) -> mitsuba.cuda_ad_rgb.Point3f:
        """
        Return the position of a bounding box corner
        """
        ...
    ...
    @overload
    def distance(self: mitsuba.cuda_ad_rgb.BoundingBox3f, arg0: mitsuba.cuda_ad_rgb.Point3f) -> drjit.cuda.ad.Float:
        """
        Calculate the shortest distance between the axis-aligned bounding box
        and the point ``p``.
    ...
    @overload
    def distance(self: mitsuba.cuda_ad_rgb.BoundingBox3f, arg0: mitsuba.cuda_ad_rgb.BoundingBox3f) -> drjit.cuda.ad.Float:
        """
        Calculate the shortest distance between the axis-aligned bounding box
        and ``bbox``.
        """
    ...
    @overload
    def expand(self: mitsuba.cuda_ad_rgb.BoundingBox3f, arg0: mitsuba.cuda_ad_rgb.Point3f) -> None:
        """
        Expand the bounding box to contain another point
    ...
    @overload
    def expand(self: mitsuba.cuda_ad_rgb.BoundingBox3f, arg0: mitsuba.cuda_ad_rgb.BoundingBox3f) -> None:
        """
        Expand the bounding box to contain another bounding box
        """
        ...

    def extents(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> mitsuba.cuda_ad_rgb.Vector3f:
        """
        Calculate the bounding box extents
    ...
    def major_axis(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> drjit.cuda.ad.UInt:
        """
        Return the dimension index with the index associated side length
        """
        ...

    def minor_axis(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> drjit.cuda.ad.UInt:
        """
        Return the dimension index with the shortest associated side length
        """
        ...

    def overlaps(self: mitsuba.cuda_ad_rgb.BoundingBox3f, bbox: mitsuba.cuda_ad_rgb.BoundingBox3f, strict: bool = False) -> drjit.cuda.ad.Bool:
        """
        Check two axis-aligned bounding boxes for possible overlap.
    ...
    def ray_intersect(self: mitsuba.cuda_ad_rgb.BoundingBox3f, ray: mitsuba.cuda_ad_rgb.Ray3f) -> Tuple[drjit.cuda.ad.Bool, drjit.cuda.ad.Float, drjit.cuda.ad.Float]:
        """
    ...
    def reset(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> None:
        """
        Mark the bounding box as invalid.
    ...
    @overload
    def squared_distance(self: mitsuba.cuda_ad_rgb.BoundingBox3f, arg0: mitsuba.cuda_ad_rgb.Point3f) -> drjit.cuda.ad.Float:
        """
        Calculate the shortest squared distance between the axis-aligned
        bounding box and the point ``p``.
    ...
    @overload
    def squared_distance(self: mitsuba.cuda_ad_rgb.BoundingBox3f, arg0: mitsuba.cuda_ad_rgb.BoundingBox3f) -> drjit.cuda.ad.Float:
        """
        Calculate the shortest squared distance between the axis-aligned
        bounding box and ``bbox``.
        """
    ...
    def surface_area(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> drjit.cuda.ad.Float:
        """
        Calculate the 2-dimensional surface area of a 3D bounding box
        """
        ...

    def valid(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> drjit.cuda.ad.Bool:
        """
        Check whether this is a valid bounding box
    ...
    def volume(self: mitsuba.cuda_ad_rgb.BoundingBox3f) -> drjit.cuda.ad.Float:
        """
        Calculate the n-dimensional volume of the bounding box
        """
        ...
...
class BoundingSphere3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BoundingSphere3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BoundingSphere3f, arg0: mitsuba.cuda_ad_rgb.Point3f, arg1: drjit.cuda.ad.Float) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.BoundingSphere3f, arg0: mitsuba.cuda_ad_rgb.BoundingSphere3f) -> None: ...
    center = ...
    radius = ...

    def contains(self: mitsuba.cuda_ad_rgb.BoundingSphere3f, p: mitsuba.cuda_ad_rgb.Point3f, strict: bool = False) -> drjit.cuda.ad.Bool:
        """
    ...
    def empty(self: mitsuba.cuda_ad_rgb.BoundingSphere3f) -> drjit.cuda.ad.Bool:
        """
        Return whether this bounding sphere has a radius of zero or less.
        """
        ...

    def expand(self: mitsuba.cuda_ad_rgb.BoundingSphere3f, arg0: mitsuba.cuda_ad_rgb.Point3f) -> None:
        """
        Expand the bounding sphere radius to contain another point.
        """
        ...

    def ray_intersect(self: mitsuba.cuda_ad_rgb.BoundingSphere3f, ray: mitsuba.cuda_ad_rgb.Ray3f) -> Tuple[drjit.cuda.ad.Bool, drjit.cuda.ad.Float, drjit.cuda.ad.Float]:
        """
        Check if a ray intersects a bounding box
        """
        ...
...
class ChainTransform3d(Transform3d):
    ...
    def assign(self: mitsuba.cuda_ad_rgb.Transform3d, arg0: mitsuba.cuda_ad_rgb.Transform3d) -> None: ...
    @overload
    def has_scale(self: mitsuba.cuda_ad_rgb.Transform3d) -> drjit.cuda.ad.Bool:
        """
    ...
    def inverse(self: mitsuba.cuda_ad_rgb.Transform3d) -> mitsuba.cuda_ad_rgb.Transform3d:
        """
    ...
    def rotate(self: mitsuba.cuda_ad_rgb.ChainTransform3d, angle: drjit.cuda.ad.Float64) -> mitsuba.cuda_ad_rgb.ChainTransform3d:
        """
    ...
    def scale(self: mitsuba.cuda_ad_rgb.ChainTransform3d, v: mitsuba.cuda_ad_rgb.Point2d) -> mitsuba.cuda_ad_rgb.ChainTransform3d:
        """
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_ad_rgb.Transform3d, p: mitsuba.cuda_ad_rgb.Point2d) -> mitsuba.cuda_ad_rgb.Point2d:
        """
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_ad_rgb.Transform3d, v: mitsuba.cuda_ad_rgb.Vector2d) -> mitsuba.cuda_ad_rgb.Vector2d:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
        """
    ...
    def translate(self: mitsuba.cuda_ad_rgb.ChainTransform3d, v: mitsuba.cuda_ad_rgb.Point2d) -> mitsuba.cuda_ad_rgb.ChainTransform3d:
        """
        Create a translation transformation
        """
        ...

    def translation(self: mitsuba.cuda_ad_rgb.Transform3d) -> mitsuba.cuda_ad_rgb.Vector2d:
        """
...
class ChainTransform3f(Transform3f):
    ...
    def assign(self: mitsuba.cuda_ad_rgb.Transform3f, arg0: mitsuba.cuda_ad_rgb.Transform3f) -> None: ...
    @overload
    def has_scale(self: mitsuba.cuda_ad_rgb.Transform3f) -> drjit.cuda.ad.Bool:
        """
        Test for a scale component in each transform matrix by checking
        whether ``M . M^T == I`` (where ``M`` is the matrix in question and
        ``I`` is the identity).
    ...
    def inverse(self: mitsuba.cuda_ad_rgb.Transform3f) -> mitsuba.cuda_ad_rgb.Transform3f:
        """
        Compute the inverse of this transformation (involves just shuffles, no
        arithmetic)
        """
    ...
    def rotate(self: mitsuba.cuda_ad_rgb.ChainTransform3f, angle: drjit.cuda.ad.Float) -> mitsuba.cuda_ad_rgb.ChainTransform3f:
        """
        Create a rotation transformation in 2D. The angle is specified in
        degrees
        """
    ...
    def scale(self: mitsuba.cuda_ad_rgb.ChainTransform3f, v: mitsuba.cuda_ad_rgb.Point2f) -> mitsuba.cuda_ad_rgb.ChainTransform3f:
        """
        Create a scale transformation
        """
        ...
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_ad_rgb.Transform3f, p: mitsuba.cuda_ad_rgb.Point2f) -> mitsuba.cuda_ad_rgb.Point2f:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_ad_rgb.Transform3f, v: mitsuba.cuda_ad_rgb.Vector2f) -> mitsuba.cuda_ad_rgb.Vector2f:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
        """
    ...
    def translate(self: mitsuba.cuda_ad_rgb.ChainTransform3f, v: mitsuba.cuda_ad_rgb.Point2f) -> mitsuba.cuda_ad_rgb.ChainTransform3f:
        """
        Create a translation transformation
        """
        ...

    def translation(self: mitsuba.cuda_ad_rgb.Transform3f) -> mitsuba.cuda_ad_rgb.Vector2f:
        """
        Get the translation part of a matrix
        """
        ...
...
class ChainTransform4d(Transform4d):
    ...
    def assign(self: mitsuba.cuda_ad_rgb.Transform4d, arg0: mitsuba.cuda_ad_rgb.Transform4d) -> None: ...
    def extract(self: mitsuba.cuda_ad_rgb.Transform4d) -> mitsuba.cuda_ad_rgb.Transform3d:
        """
        Extract a lower-dimensional submatrix
        """
        ...

    def from_frame(self: mitsuba.cuda_ad_rgb.ChainTransform4d, frame) -> mitsuba.cuda_ad_rgb.ChainTransform4d:
        """
    ...
    @overload
    def has_scale(self: mitsuba.cuda_ad_rgb.Transform4d) -> drjit.cuda.ad.Bool:
        """
        Test for a scale component in each transform matrix by checking
        whether ``M . M^T == I`` (where ``M`` is the matrix in question and
        ``I`` is the identity).
    ...
    def inverse(self: mitsuba.cuda_ad_rgb.Transform4d) -> mitsuba.cuda_ad_rgb.Transform4d:
        """
        Compute the inverse of this transformation (involves just shuffles, no
        arithmetic)
        """
    ...
    def look_at(self: mitsuba.cuda_ad_rgb.ChainTransform4d, origin: mitsuba.cuda_ad_rgb.Point3d, target: mitsuba.cuda_ad_rgb.Point3d, up: mitsuba.cuda_ad_rgb.Point3d) -> mitsuba.cuda_ad_rgb.ChainTransform4d:
        """
    ...
    def orthographic(self: mitsuba.cuda_ad_rgb.ChainTransform4d, near: drjit.cuda.ad.Float64, far: drjit.cuda.ad.Float64) -> mitsuba.cuda_ad_rgb.ChainTransform4d:
        """
    ...
    def perspective(self: mitsuba.cuda_ad_rgb.ChainTransform4d, fov: drjit.cuda.ad.Float64, near: drjit.cuda.ad.Float64, far: drjit.cuda.ad.Float64) -> mitsuba.cuda_ad_rgb.ChainTransform4d:
        """
    ...
    def rotate(self: mitsuba.cuda_ad_rgb.ChainTransform4d, axis: mitsuba.cuda_ad_rgb.Point3d, angle: drjit.cuda.ad.Float64) -> mitsuba.cuda_ad_rgb.ChainTransform4d:
        """
    ...
    def scale(self: mitsuba.cuda_ad_rgb.ChainTransform4d, v: mitsuba.cuda_ad_rgb.Point3d) -> mitsuba.cuda_ad_rgb.ChainTransform4d:
        """
        Create a scale transformation
        """
        ...

    def to_frame(self: mitsuba.cuda_ad_rgb.ChainTransform4d, frame) -> mitsuba.cuda_ad_rgb.ChainTransform4d:
        """
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_ad_rgb.Transform4d, p: mitsuba.cuda_ad_rgb.Point3d) -> mitsuba.cuda_ad_rgb.Point3d:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_ad_rgb.Transform4d, ray):
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_ad_rgb.Transform4d, v: mitsuba.cuda_ad_rgb.Vector3d) -> mitsuba.cuda_ad_rgb.Vector3d:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_ad_rgb.Transform4d, n: mitsuba.cuda_ad_rgb.Normal3d) -> mitsuba.cuda_ad_rgb.Normal3d:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
        """
    ...
    def translate(self: mitsuba.cuda_ad_rgb.ChainTransform4d, v: mitsuba.cuda_ad_rgb.Point3d) -> mitsuba.cuda_ad_rgb.ChainTransform4d:
        """
        Create a translation transformation
        """
        ...

    def translation(self: mitsuba.cuda_ad_rgb.Transform4d) -> mitsuba.cuda_ad_rgb.Vector3d:
        """
        Get the translation part of a matrix
        """
        ...
...
class ChainTransform4f(Transform4f):
    ...
    def assign(self: mitsuba.cuda_ad_rgb.Transform4f, arg0: mitsuba.cuda_ad_rgb.Transform4f) -> None: ...
    def extract(self: mitsuba.cuda_ad_rgb.Transform4f) -> mitsuba.cuda_ad_rgb.Transform3f:
        """
        Extract a lower-dimensional submatrix
        """
        ...

    def from_frame(self: mitsuba.cuda_ad_rgb.ChainTransform4f, frame: mitsuba.cuda_ad_rgb.Frame3f) -> mitsuba.cuda_ad_rgb.ChainTransform4f:
        """
        Creates a transformation that converts from 'frame' to the standard
        basis
        """
    ...
    @overload
    def has_scale(self: mitsuba.cuda_ad_rgb.Transform4f) -> drjit.cuda.ad.Bool:
        """
        Test for a scale component in each transform matrix by checking
        whether ``M . M^T == I`` (where ``M`` is the matrix in question and
        ``I`` is the identity).
    ...
    def inverse(self: mitsuba.cuda_ad_rgb.Transform4f) -> mitsuba.cuda_ad_rgb.Transform4f:
        """
        Compute the inverse of this transformation (involves just shuffles, no
        arithmetic)
        """
    ...
    def look_at(self: mitsuba.cuda_ad_rgb.ChainTransform4f, origin: mitsuba.cuda_ad_rgb.Point3f, target: mitsuba.cuda_ad_rgb.Point3f, up: mitsuba.cuda_ad_rgb.Point3f) -> mitsuba.cuda_ad_rgb.ChainTransform4f:
        """
        Create a look-at camera transformation
    ...
    def orthographic(self: mitsuba.cuda_ad_rgb.ChainTransform4f, near: drjit.cuda.ad.Float, far: drjit.cuda.ad.Float) -> mitsuba.cuda_ad_rgb.ChainTransform4f:
        """
        Create an orthographic transformation, which maps Z to [0,1] and
        leaves the X and Y coordinates untouched.
    ...
    def perspective(self: mitsuba.cuda_ad_rgb.ChainTransform4f, fov: drjit.cuda.ad.Float, near: drjit.cuda.ad.Float, far: drjit.cuda.ad.Float) -> mitsuba.cuda_ad_rgb.ChainTransform4f:
        """
        Create a perspective transformation. (Maps [near, far] to [0, 1])
    ...
    def rotate(self: mitsuba.cuda_ad_rgb.ChainTransform4f, axis: mitsuba.cuda_ad_rgb.Point3f, angle: drjit.cuda.ad.Float) -> mitsuba.cuda_ad_rgb.ChainTransform4f:
        """
        Create a rotation transformation around an arbitrary axis in 3D. The
        angle is specified in degrees
        """
    ...
    def scale(self: mitsuba.cuda_ad_rgb.ChainTransform4f, v: mitsuba.cuda_ad_rgb.Point3f) -> mitsuba.cuda_ad_rgb.ChainTransform4f:
        """
        Create a scale transformation
        """
        ...

    def to_frame(self: mitsuba.cuda_ad_rgb.ChainTransform4f, frame: mitsuba.cuda_ad_rgb.Frame3f) -> mitsuba.cuda_ad_rgb.ChainTransform4f:
        """
        Creates a transformation that converts from the standard basis to
        'frame'
        """
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_ad_rgb.Transform4f, p: mitsuba.cuda_ad_rgb.Point3f) -> mitsuba.cuda_ad_rgb.Point3f:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_ad_rgb.Transform4f, ray: mitsuba.cuda_ad_rgb.Ray3f) -> mitsuba.cuda_ad_rgb.Ray3f:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_ad_rgb.Transform4f, v: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.cuda_ad_rgb.Vector3f:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
    ...
    @overload
    def transform_affine(self: mitsuba.cuda_ad_rgb.Transform4f, n: mitsuba.cuda_ad_rgb.Normal3f) -> mitsuba.cuda_ad_rgb.Normal3f:
        """
        Transform a 3D vector/point/normal/ray by a transformation that is
        known to be an affine 3D transformation (i.e. no perspective)
        """
    ...
    def translate(self: mitsuba.cuda_ad_rgb.ChainTransform4f, v: mitsuba.cuda_ad_rgb.Point3f) -> mitsuba.cuda_ad_rgb.ChainTransform4f:
        """
        Create a translation transformation
        """
        ...

    def translation(self: mitsuba.cuda_ad_rgb.Transform4f) -> mitsuba.cuda_ad_rgb.Vector3f:
        """
        Get the translation part of a matrix
        """
        ...
...
from drjit.cuda.ad import Array0f64
class Color0d(Array0f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Color0d, *args) -> None: ...
    label = ...

    def assign(self, other): ...
    ...

from drjit.cuda.ad import Array0f
class Color0f(Array0f):
    def __init__(self: mitsuba.cuda_ad_rgb.Color0f, *args) -> None: ...
    label = ...

    def assign(self, other): ...
    ...

from drjit.cuda.ad import Array1f64
class Color1d(Array1f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Color1d, *args) -> None: ...
    label = ...
    x = ...
...
from drjit.cuda.ad import Array1f
class Color1f(Array1f):
    def __init__(self: mitsuba.cuda_ad_rgb.Color1f, *args) -> None: ...
    label = ...
    x = ...
...
from drjit.cuda.ad import Array3f64
class Color3d(Array3f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Color3d, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class Color3f(Array3f):
    def __init__(self: mitsuba.cuda_ad_rgb.Color3f, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class ContinuousDistribution:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> None:
        """
        Continuous 1D probability distribution defined in terms of a regularly
        sampled linear interpolant
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, arg0: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, range: mitsuba.Vector2f, pdf: drjit.cuda.ad.Float) -> None:
        """
        Initialize from a given density function on the interval ``range``
        """
        ...

    def cdf(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> drjit.cuda.ad.Float:
        """
    ...
    def empty(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> bool:
        """
        Is the distribution object empty/uninitialized?
        """
        ...

    def eval_cdf(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, x: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def eval_cdf_normalized(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, x: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        position ``p``
        """
    ...
    def eval_pdf(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, x: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def eval_pdf_normalized(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, x: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def integral(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> drjit.cuda.ad.Float:
        """
        Return the original integral of PDF entries before normalization
        """
        ...

    def interval_resolution(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> float:
        """
        Return the minimum resolution of the discretization
        """
        ...

    def normalization(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> drjit.cuda.ad.Float:
        """
        Return the normalization factor (i.e. the inverse of sum())
        """
        ...

    def pdf(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> drjit.cuda.ad.Float:
        """
        Return the unnormalized discretized probability density function
        """
        ...

    def range(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> mitsuba.Vector2f:
        """
        Return the range of the distribution
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, value: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def sample_pdf(self: mitsuba.cuda_ad_rgb.ContinuousDistribution, value: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> Tuple[drjit.cuda.ad.Float, drjit.cuda.ad.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def size(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> int:
        """
        Return the number of discretizations
        """
        ...

    def update(self: mitsuba.cuda_ad_rgb.ContinuousDistribution) -> None:
        """
...
class CppADIntegrator(SamplingIntegrator):
    def __init__(self: mitsuba.cuda_ad_rgb.CppADIntegrator, arg0: mitsuba.Properties) -> None: ...
    ptr = ...
    ...
    def sample(self: mitsuba.cuda_ad_rgb.SamplingIntegrator, scene: mitsuba.cuda_ad_rgb.Scene, sampler, ray: mitsuba.cuda_ad_rgb.RayDifferential3f, medium: mitsuba.cuda_ad_rgb.Medium = None, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, drjit.cuda.ad.Bool, List[drjit.cuda.ad.Float]]:
        """
...
class DirectionSample3f(PositionSample3f):
    ...
    *direct illumination strategies* importance sample the incident
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.DirectionSample3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.DirectionSample3f, other: mitsuba.cuda_ad_rgb.PositionSample3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.DirectionSample3f, other: mitsuba.cuda_ad_rgb.DirectionSample3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.DirectionSample3f, p: mitsuba.cuda_ad_rgb.Point3f, n: mitsuba.cuda_ad_rgb.Normal3f, uv: mitsuba.cuda_ad_rgb.Point2f, time: drjit.cuda.ad.Float, pdf: drjit.cuda.ad.Float, delta: drjit.cuda.ad.Bool, d: mitsuba.cuda_ad_rgb.Vector3f, dist: drjit.cuda.ad.Float, emitter: mitsuba.cuda_ad_rgb.EmitterPtr) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.DirectionSample3f, scene: mitsuba.cuda_ad_rgb.Scene, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, ref: mitsuba.cuda_ad_rgb.Interaction3f) -> None:
        """
    ...
    def assign(self: mitsuba.cuda_ad_rgb.DirectionSample3f, arg0: mitsuba.cuda_ad_rgb.DirectionSample3f) -> None: ...
    ...
...
class DiscreteDistribution:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.DiscreteDistribution) -> None:
        """
        Discrete 1D probability distribution
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, arg0: mitsuba.cuda_ad_rgb.DiscreteDistribution) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, pmf: drjit.cuda.ad.Float) -> None:
        """
        Initialize from a given probability mass function
        """
        ...

    def cdf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution) -> drjit.cuda.ad.Float:
        """
        Return the unnormalized cumulative distribution function
        """
        ...

    def empty(self: mitsuba.cuda_ad_rgb.DiscreteDistribution) -> bool:
        """
        Is the distribution object empty/uninitialized?
        """
        ...

    def eval_cdf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, index: drjit.cuda.ad.UInt, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        index ``index``
        """
    ...
    def eval_cdf_normalized(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, index: drjit.cuda.ad.UInt, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def eval_pmf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, index: drjit.cuda.ad.UInt, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def eval_pmf_normalized(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, index: drjit.cuda.ad.UInt, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def normalization(self: mitsuba.cuda_ad_rgb.DiscreteDistribution) -> drjit.cuda.ad.Float:
        """
        Return the normalization factor (i.e. the inverse of sum())
        """
        ...

    def pmf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution) -> drjit.cuda.ad.Float:
        """
        Return the unnormalized probability mass function
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, value: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.UInt:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_pmf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, value: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> Tuple[drjit.cuda.ad.UInt, drjit.cuda.ad.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_reuse(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, value: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> Tuple[drjit.cuda.ad.UInt, drjit.cuda.ad.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_reuse_pmf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution, value: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> Tuple[drjit.cuda.ad.UInt, drjit.cuda.ad.Float, drjit.cuda.ad.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution.
    ...
    def size(self: mitsuba.cuda_ad_rgb.DiscreteDistribution) -> int:
        """
        Return the number of entries
        """
        ...

    def sum(self: mitsuba.cuda_ad_rgb.DiscreteDistribution) -> drjit.cuda.ad.Float:
        """
        Return the original sum of PMF entries before normalization
        """
        ...

    def update(self: mitsuba.cuda_ad_rgb.DiscreteDistribution) -> None:
        """
...
class DiscreteDistribution2D:
    def __init__(self: mitsuba.cuda_ad_rgb.DiscreteDistribution2D, data: numpy.ndarray[numpy.float32]) -> None: ...
    def eval(self: mitsuba.cuda_ad_rgb.DiscreteDistribution2D, pos: mitsuba.cuda_ad_rgb.Point2u, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float: ...
    def pdf(self: mitsuba.cuda_ad_rgb.DiscreteDistribution2D, pos: mitsuba.cuda_ad_rgb.Point2u, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float: ...
    def sample(self: mitsuba.cuda_ad_rgb.DiscreteDistribution2D, sample: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2u, drjit.cuda.ad.Float, mitsuba.cuda_ad_rgb.Point2f]: ...
    ...
...
class Emitter(Endpoint):
    def __init__(self: mitsuba.cuda_ad_rgb.Emitter, arg0: mitsuba.Properties) -> None: ...
    m_flags = ...
    m_needs_sample_2 = ...
    m_needs_sample_3 = ...
    ptr = ...

    def bbox(self: mitsuba.cuda_ad_rgb.Endpoint) -> mitsuba.BoundingBox3f:
        """
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Endpoint, si, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_direction(self: mitsuba.cuda_ad_rgb.Endpoint, it, ds, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def flags(self: mitsuba.cuda_ad_rgb.Emitter, active: drjit.cuda.ad.Bool = True) -> int:
        """
        Flags for all components combined.
        """
        ...
    ...
    def is_environment(self: mitsuba.cuda_ad_rgb.Emitter) -> bool:
        """
        Is this an environment map light emitter?
        """
        ...

    def medium(self: mitsuba.cuda_ad_rgb.Endpoint) -> mitsuba.cuda_ad_rgb.Medium:
        """
        Return a pointer to the medium that surrounds the emitter
        """
        ...

    def needs_sample_2(self: mitsuba.cuda_ad_rgb.Endpoint) -> bool:
        """
    ...
    def needs_sample_3(self: mitsuba.cuda_ad_rgb.Endpoint) -> bool:
        """
        Does the method sample_ray() require a uniformly distributed 2D sample
    ...
    def pdf_direction(self: mitsuba.cuda_ad_rgb.Endpoint, it, ds, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def sample_direction(self: mitsuba.cuda_ad_rgb.Endpoint, it, sample: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True):
        """
    ...
    def sample_ray(self: mitsuba.cuda_ad_rgb.Endpoint, time: drjit.cuda.ad.Float, sample1: drjit.cuda.ad.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, sample3: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Ray3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
    ...
    def sample_wavelengths(self: mitsuba.cuda_ad_rgb.Endpoint, si, sample: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color0f, mitsuba.cuda_ad_rgb.Color3f]:
        """
    ...
    def set_medium(self: mitsuba.cuda_ad_rgb.Endpoint, medium: mitsuba.cuda_ad_rgb.Medium) -> None:
        """
        Set the medium that surrounds the emitter.
        """
        ...

    def set_scene(self: mitsuba.cuda_ad_rgb.Endpoint, scene: mitsuba.cuda_ad_rgb.Scene) -> None:
        """
    ...
    def set_shape(self: mitsuba.cuda_ad_rgb.Endpoint, shape: mitsuba.cuda_ad_rgb.Shape) -> None:
        """
        Set the shape associated with this endpoint.
        """
        ...

    def shape(self: mitsuba.cuda_ad_rgb.Endpoint) -> mitsuba.cuda_ad_rgb.Shape:
        """
    ...
    def world_transform(self: mitsuba.cuda_ad_rgb.Endpoint) -> mitsuba.cuda_ad_rgb.Transform4f:
        """
...
from drjit import ArrayBase
class EmitterPtr(ArrayBase):
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.EmitterPtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.EmitterPtr, arg0: mitsuba.cuda_ad_rgb.Emitter) -> None: ...
    index = ...
    label = ...

    def assign(self: mitsuba.cuda_ad_rgb.EmitterPtr, arg0: mitsuba.cuda_ad_rgb.EmitterPtr) -> None: ...
    def eval(self: mitsuba.cuda_ad_rgb.EmitterPtr, si, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Given a ray-surface intersection, return the emitted radiance or
        importance traveling along the reverse direction
    ...
    def flags(self: mitsuba.cuda_ad_rgb.EmitterPtr) -> drjit.cuda.ad.UInt:
        """
        Flags for all components combined.
        """
        ...

    def is_environment(self: mitsuba.cuda_ad_rgb.EmitterPtr) -> drjit.cuda.ad.Bool:
        """
        Is this an environment map light emitter?
        """
        ...

    def pdf_direction(self: mitsuba.cuda_ad_rgb.EmitterPtr, it, ds, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the probability density of the *direct* sampling method
        implemented by the sample_direction() method.
    ...
    def sample_direction(self: mitsuba.cuda_ad_rgb.EmitterPtr, it, sample: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True):
        """
        Given a reference point in the scene, sample a direction from the
        reference point towards the endpoint (ideally proportional to the
        emission/sensitivity profile)
    ...
    def sample_position(self: mitsuba.cuda_ad_rgb.EmitterPtr, time: drjit.cuda.ad.Float, sample: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True):
        """
    ...
    def sample_ray(self: mitsuba.cuda_ad_rgb.EmitterPtr, time: drjit.cuda.ad.Float, sample1: drjit.cuda.ad.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, sample3: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Ray3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample a ray proportional to the endpoint's
        sensitivity/emission profile.
    ...
    def sample_wavelengths(self: mitsuba.cuda_ad_rgb.EmitterPtr, si, sample: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color0f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample a set of wavelengths according to the endpoint's
        sensitivity/emission spectrum.
    ...
    def shape(self: mitsuba.cuda_ad_rgb.EmitterPtr) -> mitsuba.cuda_ad_rgb.ShapePtr:
        """
        Return the shape, to which the emitter is currently attached
        """
        ...
...
class Film(Object):
    ...
    def bitmap(self: mitsuba.cuda_ad_rgb.Film, raw: bool = False) -> mitsuba.Bitmap:
        """
        Return a bitmap object storing the developed contents of the film
        """
        ...

    def create_block(self: mitsuba.cuda_ad_rgb.Film, size: mitsuba.Vector2u = [0, 0], normalize: bool = False, borders: bool = False):
        """
    ...
    def crop_offset(self: mitsuba.cuda_ad_rgb.Film) -> mitsuba.Point2u:
        """
        Return the offset of the crop window
        """
        ...

    def crop_size(self: mitsuba.cuda_ad_rgb.Film) -> mitsuba.Vector2u:
        """
    ...
    def develop(self: mitsuba.cuda_ad_rgb.Film, raw: bool = False) -> drjit.cuda.ad.TensorXf:
        """
    ...
    def flags(self: mitsuba.cuda_ad_rgb.Film) -> int:
        """
    ...
    def prepare(self: mitsuba.cuda_ad_rgb.Film, aovs: List[str]) -> int:
        """
    ...
    def prepare_sample(self: mitsuba.cuda_ad_rgb.Film, spec: mitsuba.cuda_ad_rgb.Color3f, wavelengths: mitsuba.cuda_ad_rgb.Color0f, nChannels: int, weight: drjit.cuda.ad.Float = 1.0, alpha: drjit.cuda.ad.Float = 1.0, active: drjit.cuda.ad.Bool = True) -> List[drjit.cuda.ad.Float]:
        """
    ...
    def put_block(self: mitsuba.cuda_ad_rgb.Film, block) -> None:
        """
    ...
    def rfilter(self: mitsuba.cuda_ad_rgb.Film) -> mitsuba.cuda_ad_rgb.ReconstructionFilter:
        """
        Return the image reconstruction filter (const version)
        """
        ...

    def sample_border(self: mitsuba.cuda_ad_rgb.Film) -> bool:
        """
    ...
    def schedule_storage(self: mitsuba.cuda_ad_rgb.Film) -> None:
        """
        dr::schedule() variables that represent the internal film storage
        """
        ...

    def sensor_response_function(self: mitsuba.cuda_ad_rgb.Film):
        """
        Returns the specific Sensor Response Function (SRF) used by the film
        """
        ...

    def set_crop_window(self: mitsuba.cuda_ad_rgb.Film, crop_offset: mitsuba.Point2u, crop_size: mitsuba.Vector2u) -> None:
        """
    ...
    def set_size(self: mitsuba.cuda_ad_rgb.Film, size: mitsuba.Point2u) -> None:
        """
    ...
    def size(self: mitsuba.cuda_ad_rgb.Film) -> mitsuba.Vector2u:
        """
    ...
    def write(self: mitsuba.cuda_ad_rgb.Film, path: mitsuba.filesystem.path) -> None:
        """
...
class Float(ArrayBase):
    ...
    def 10. __init__(self: drjit.cuda.ad.Float, *args) -> None: ...
    index = ...
    index_ad = ...
    label = ...
...
class Float64(ArrayBase):
    ...
    def 10. __init__(self: drjit.cuda.ad.Float64, *args) -> None: ...
    index = ...
    index_ad = ...
    label = ...
...
class Frame3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Frame3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Frame3f, arg0: mitsuba.cuda_ad_rgb.Frame3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Frame3f, arg0: mitsuba.cuda_ad_rgb.Vector3f, arg1: mitsuba.cuda_ad_rgb.Vector3f, arg2: mitsuba.cuda_ad_rgb.Vector3f) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Frame3f, arg0: mitsuba.cuda_ad_rgb.Vector3f) -> None: ...
    n = ...
    s = ...
    t = ...

    def assign(self: mitsuba.cuda_ad_rgb.Frame3f, arg0: mitsuba.cuda_ad_rgb.Frame3f) -> None: ...
    def to_local(self: mitsuba.cuda_ad_rgb.Frame3f, v: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.cuda_ad_rgb.Vector3f:
        """
        Convert from world coordinates to local coordinates
        """
        ...

    def to_world(self: mitsuba.cuda_ad_rgb.Frame3f, v: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.cuda_ad_rgb.Vector3f:
        """
...
class Hierarchical2D0:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.Hierarchical2D0, data: numpy.ndarray[numpy.float32], param_values: List[List[float][0]] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Hierarchical2D0, pos: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array0f = [], active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.Hierarchical2D0, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array0f = [], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.Hierarchical2D0, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array0f = [], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
...
class Hierarchical2D1:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.Hierarchical2D1, data: numpy.ndarray[numpy.float32], param_values: List[List[float][1]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Hierarchical2D1, pos: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array1f = [0.0], active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.Hierarchical2D1, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array1f = [0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.Hierarchical2D1, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array1f = [0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Hierarchical2D2:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.Hierarchical2D2, data: numpy.ndarray[numpy.float32], param_values: List[List[float][2]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Hierarchical2D2, pos: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array2f = [0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.Hierarchical2D2, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array2f = [0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.Hierarchical2D2, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array2f = [0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Hierarchical2D3:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.Hierarchical2D3, data: numpy.ndarray[numpy.float32], param_values: List[List[float][3]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a hierarchical sample warping scheme for floating point data
        of resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Hierarchical2D3, pos: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array3f = [0.0, 0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.Hierarchical2D3, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array3f = [0.0, 0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.Hierarchical2D3, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array3f = [0.0, 0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class ImageBlock(Object):
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.ImageBlock, size: mitsuba.Vector2u, offset: mitsuba.Point2i, channel_count: int, rfilter: mitsuba.cuda_ad_rgb.ReconstructionFilter = None, border: bool = False, normalize: bool = False, coalesce: bool = False, warn_negative: bool = False, warn_invalid: bool = False) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.ImageBlock, tensor: drjit.cuda.ad.TensorXf, offset: mitsuba.Point2i = [0, 0], rfilter: mitsuba.cuda_ad_rgb.ReconstructionFilter = None, border: bool = False, normalize: bool = False, coalesce: bool = False, warn_negative: bool = False, warn_invalid: bool = False) -> None: ...
    ptr = ...

    def border_size(self: mitsuba.cuda_ad_rgb.ImageBlock) -> int:
        """
        Return the border region used by the reconstruction filter
        """
        ...

    def channel_count(self: mitsuba.cuda_ad_rgb.ImageBlock) -> int:
        """
        Return the number of channels stored by the image block
        """
        ...

    def clear(self: mitsuba.cuda_ad_rgb.ImageBlock) -> None:
        """
        Clear the image block contents to zero.
        """
        ...

    def coalesce(self: mitsuba.cuda_ad_rgb.ImageBlock) -> bool:
        """
    ...
    def has_border(self: mitsuba.cuda_ad_rgb.ImageBlock) -> bool:
        """
        Does the image block have a border region?
        """
        ...

    def height(self: mitsuba.cuda_ad_rgb.ImageBlock) -> int:
        """
        Return the bitmap's height in pixels
        """
        ...
    ...
    def normalize(self: mitsuba.cuda_ad_rgb.ImageBlock) -> bool:
        """
        Re-normalize filter weights in put() and read()
        """
        ...

    def offset(self: mitsuba.cuda_ad_rgb.ImageBlock) -> mitsuba.Point2i:
        """
    ...
    @overload
    def put(self: mitsuba.cuda_ad_rgb.ImageBlock, pos: mitsuba.cuda_ad_rgb.Point2f, wavelengths: mitsuba.cuda_ad_rgb.Color0f, value: mitsuba.cuda_ad_rgb.Color3f, alpha: drjit.cuda.ad.Float = 1.0, weight: drjit.cuda.ad.Float = 1, active: drjit.cuda.ad.Bool = True) -> None:
        """
    ...
    @overload
    def put(self: mitsuba.cuda_ad_rgb.ImageBlock, pos: mitsuba.cuda_ad_rgb.Point2f, values: List[drjit.cuda.ad.Float], active: drjit.cuda.ad.Bool = True) -> None: ...
    def put_block(self: mitsuba.cuda_ad_rgb.ImageBlock, block: mitsuba.cuda_ad_rgb.ImageBlock) -> None:
        """
        Accumulate a single sample or a wavefront of samples into the image
        block.
    ...
    def read(self: mitsuba.cuda_ad_rgb.ImageBlock, pos: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> List[drjit.cuda.ad.Float]: ...
    def ref_count(self: mitsuba.Object) -> int:
        """
        Return the current reference count
        """
    ...
    def rfilter(self: mitsuba.cuda_ad_rgb.ImageBlock) -> mitsuba.cuda_ad_rgb.ReconstructionFilter:
        """
        Return the image reconstruction filter underlying the ImageBlock
        """
        ...

    def set_coalesce(self: mitsuba.cuda_ad_rgb.ImageBlock, arg0: bool) -> None:
        """
        Try to coalesce reads/writes in JIT modes?
        """
        ...
    ...
    def set_normalize(self: mitsuba.cuda_ad_rgb.ImageBlock, arg0: bool) -> None:
        """
        Re-normalize filter weights in put() and read()
        """
        ...

    def set_offset(self: mitsuba.cuda_ad_rgb.ImageBlock, offset: mitsuba.Point2i) -> None:
        """
    ...
    def set_size(self: mitsuba.cuda_ad_rgb.ImageBlock, size: mitsuba.Vector2u) -> None:
        """
        Set the block size. This potentially destroys the block's content.
        """
        ...

    def set_warn_invalid(self: mitsuba.cuda_ad_rgb.ImageBlock, value: bool) -> None:
        """
        Warn when writing invalid (NaN, +/- infinity) sample values?
        """
        ...

    def set_warn_negative(self: mitsuba.cuda_ad_rgb.ImageBlock, value: bool) -> None:
        """
        Warn when writing negative sample values?
        """
        ...

    def size(self: mitsuba.cuda_ad_rgb.ImageBlock) -> mitsuba.Vector2u:
        """
        Return the current block size
        """
        ...

    def tensor(self: mitsuba.cuda_ad_rgb.ImageBlock) -> drjit.cuda.ad.TensorXf:
        """
    ...
    def warn_invalid(self: mitsuba.cuda_ad_rgb.ImageBlock) -> bool:
        """
        Warn when writing invalid (NaN, +/- infinity) sample values?
        """
        ...

    def warn_negative(self: mitsuba.cuda_ad_rgb.ImageBlock) -> bool:
        """
        Warn when writing negative sample values?
        """
        ...

    def width(self: mitsuba.cuda_ad_rgb.ImageBlock) -> int:
        """
        Return the bitmap's width in pixels
        """
        ...
...
class Int(ArrayBase):
    ...
    def 10. __init__(self: drjit.cuda.ad.Int, *args) -> None: ...
    index = ...
    index_ad = ...
    label = ...
...
class Int64(ArrayBase):
    ...
    def 10. __init__(self: drjit.cuda.ad.Int64, *args) -> None: ...
    index = ...
    index_ad = ...
    label = ...
...
class Interaction3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Interaction3f) -> None:
        """
        Constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Interaction3f, arg0: mitsuba.cuda_ad_rgb.Interaction3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Interaction3f, t: drjit.cuda.ad.Float, time: drjit.cuda.ad.Float, wavelengths: mitsuba.cuda_ad_rgb.Color0f, p: mitsuba.cuda_ad_rgb.Point3f, n: mitsuba.cuda_ad_rgb.Normal3f = 0) -> None: ...
    n = ...
    ...
    def assign(self: mitsuba.cuda_ad_rgb.Interaction3f, arg0: mitsuba.cuda_ad_rgb.Interaction3f) -> None: ...
    def is_valid(self: mitsuba.cuda_ad_rgb.Interaction3f) -> drjit.cuda.ad.Bool:
        """
        Is the current interaction valid?
        """
        ...

    def spawn_ray(self: mitsuba.cuda_ad_rgb.Interaction3f, d: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.cuda_ad_rgb.Ray3f:
        """
        Spawn a semi-infinite ray towards the given direction
        """
        ...

    def spawn_ray_to(self: mitsuba.cuda_ad_rgb.Interaction3f, t: mitsuba.cuda_ad_rgb.Point3f) -> mitsuba.cuda_ad_rgb.Ray3f:
        """
...
class IrregularContinuousDistribution:
    ...
    *irregularly* sampled linear interpolant
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> None:
        """
        Continuous 1D probability distribution defined in terms of an
        *irregularly* sampled linear interpolant
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, arg0: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, nodes: drjit.cuda.ad.Float, pdf: drjit.cuda.ad.Float) -> None:
        """
    ...
    def cdf(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> drjit.cuda.ad.Float:
        """
        Return the unnormalized discrete cumulative distribution function over
        intervals
        """
    ...
    def empty(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> bool:
        """
        Is the distribution object empty/uninitialized?
        """
        ...

    def eval_cdf(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, x: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        position ``p``
        """
    ...
    def eval_cdf_normalized(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, x: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the unnormalized cumulative distribution function (CDF) at
        position ``p``
        """
    ...
    def eval_pdf(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, x: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the unnormalized probability mass function (PDF) at position
        ``x``
        """
    ...
    def eval_pdf_normalized(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, x: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the normalized probability mass function (PDF) at position
        ``x``
        """
    ...
    def integral(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> drjit.cuda.ad.Float:
        """
        Return the original integral of PDF entries before normalization
        """
        ...

    def interval_resolution(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> float:
        """
        Return the minimum resolution of the discretization
        """
        ...

    def nodes(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> drjit.cuda.ad.Float:
        """
        Return the nodes of the underlying discretization
        """
        ...

    def normalization(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> drjit.cuda.ad.Float:
        """
        Return the normalization factor (i.e. the inverse of sum())
        """
        ...

    def pdf(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> drjit.cuda.ad.Float:
        """
        Return the unnormalized discretized probability density function
        """
        ...

    def range(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> drjit.scalar.Array2f:
        """
        Return the range of the distribution
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, value: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def sample_pdf(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution, value: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> Tuple[drjit.cuda.ad.Float, drjit.cuda.ad.Float]:
        """
        %Transform a uniformly distributed sample to the stored distribution
    ...
    def size(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> int:
        """
        Return the number of discretizations
        """
        ...

    def update(self: mitsuba.cuda_ad_rgb.IrregularContinuousDistribution) -> None:
        """
...
from drjit.cuda.ad import LoopBase
class Loop(LoopBase):
...
class MarginalContinuous2D0:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D0, data: numpy.ndarray[numpy.float32], param_values: List[List[float][0]] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D0, pos: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array0f = [], active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D0, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array0f = [], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D0, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array0f = [], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D1:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D1, data: numpy.ndarray[numpy.float32], param_values: List[List[float][1]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D1, pos: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array1f = [0.0], active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D1, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array1f = [0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D1, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array1f = [0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D2:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D2, data: numpy.ndarray[numpy.float32], param_values: List[List[float][2]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D2, pos: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array2f = [0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D2, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array2f = [0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D2, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array2f = [0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalContinuous2D3:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D3, data: numpy.ndarray[numpy.float32], param_values: List[List[float][3]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D3, pos: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array3f = [0.0, 0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D3, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array3f = [0.0, 0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalContinuous2D3, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array3f = [0.0, 0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D0:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D0, data: numpy.ndarray[numpy.float32], param_values: List[List[float][0]] = [], normalize: bool = True, enable_sampling: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D0, pos: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array0f = [], active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D0, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array0f = [], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D0, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array0f = [], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D1:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D1, data: numpy.ndarray[numpy.float32], param_values: List[List[float][1]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D1, pos: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array1f = [0.0], active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D1, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array1f = [0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D1, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array1f = [0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D2:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D2, data: numpy.ndarray[numpy.float32], param_values: List[List[float][2]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D2, pos: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array2f = [0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D2, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array2f = [0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D2, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array2f = [0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class MarginalDiscrete2D3:
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D3, data: numpy.ndarray[numpy.float32], param_values: List[List[float][3]], normalize: bool = True, build_hierarchy: bool = True) -> None:
        """
        Construct a marginal sample warping scheme for floating point data of
        resolution ``size``.
    ...
    def eval(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D3, pos: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array3f = [0.0, 0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the density at position ``pos``. The distribution is
        parameterized by ``param`` if applicable.
        """
    ...
    def invert(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D3, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array3f = [0.0, 0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Inverse of the mapping implemented in ``sample()``
        """
        ...

    def sample(self: mitsuba.cuda_ad_rgb.MarginalDiscrete2D3, sample: drjit.cuda.ad.Array2f, param: drjit.cuda.ad.Array3f = [0.0, 0.0, 0.0], active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
        Given a uniformly distributed 2D sample, draw a sample from the
        distribution (parameterized by ``param`` if applicable)
...
class Medium(Object):
    def __init__(self: mitsuba.cuda_ad_rgb.Medium, arg0: mitsuba.Properties) -> None: ...
    ...
    def eval_tr_and_pdf(self: mitsuba.cuda_ad_rgb.Medium, mi, si, active: drjit.cuda.ad.Bool) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
    ...
    def get_majorant(self: mitsuba.cuda_ad_rgb.Medium, mi, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Returns the medium's majorant used for delta tracking
        """
        ...

    def get_scattering_coefficients(self: mitsuba.cuda_ad_rgb.Medium, mi, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
    ...
    def has_spectral_extinction(self: mitsuba.cuda_ad_rgb.Medium) -> bool:
        """
        Returns whether this medium has a spectrally varying extinction
        """
        ...

    def id(self: mitsuba.cuda_ad_rgb.Medium) -> str:
        """
        Return a string identifier
        """
        ...
    ...
    def intersect_aabb(self: mitsuba.cuda_ad_rgb.Medium, ray: mitsuba.cuda_ad_rgb.Ray3f) -> Tuple[drjit.cuda.ad.Bool, drjit.cuda.ad.Float, drjit.cuda.ad.Float]:
        """
        Intersects a ray with the medium's bounding box
        """
        ...

    def is_homogeneous(self: mitsuba.cuda_ad_rgb.Medium) -> bool:
        """
    ...
    def phase_function(self: mitsuba.cuda_ad_rgb.Medium):
        """
    ...
    def sample_interaction(self: mitsuba.cuda_ad_rgb.Medium, ray: mitsuba.cuda_ad_rgb.Ray3f, sample: drjit.cuda.ad.Float, channel: drjit.cuda.ad.UInt, active: drjit.cuda.ad.Bool):
        """
    ...
    def use_emitter_sampling(self: mitsuba.cuda_ad_rgb.Medium) -> bool:
        """
...
class MediumInteraction3f(Interaction3f):
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.MediumInteraction3f) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.MediumInteraction3f, arg0: mitsuba.cuda_ad_rgb.MediumInteraction3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def assign(self: mitsuba.cuda_ad_rgb.MediumInteraction3f, arg0: mitsuba.cuda_ad_rgb.MediumInteraction3f) -> None: ...
    def is_valid(self: mitsuba.cuda_ad_rgb.Interaction3f) -> drjit.cuda.ad.Bool:
        """
        Is the current interaction valid?
        """
    ...
    def to_local(self: mitsuba.cuda_ad_rgb.MediumInteraction3f, v: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.cuda_ad_rgb.Vector3f:
        """
        Convert a world-space vector into local shading coordinates
        """
        ...

    def to_world(self: mitsuba.cuda_ad_rgb.MediumInteraction3f, v: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.cuda_ad_rgb.Vector3f:
        """
...
from drjit import ArrayBase
class MediumPtr(ArrayBase):
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.MediumPtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.MediumPtr, arg0: mitsuba.cuda_ad_rgb.Medium) -> None: ...
    index = ...
    label = ...

    def assign(self: mitsuba.cuda_ad_rgb.MediumPtr, arg0: mitsuba.cuda_ad_rgb.MediumPtr) -> None: ...
    def eval_tr_and_pdf(self: mitsuba.cuda_ad_rgb.MediumPtr, mi, si, active: drjit.cuda.ad.Bool) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Compute the transmittance and PDF
    ...
    def get_majorant(self: mitsuba.cuda_ad_rgb.MediumPtr, mi, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Returns the medium's majorant used for delta tracking
        """
        ...

    def get_scattering_coefficients(self: mitsuba.cuda_ad_rgb.MediumPtr, mi, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Returns the medium coefficients Sigma_s, Sigma_n and Sigma_t evaluated
        at a given MediumInteraction mi
        """
    ...
    def has_spectral_extinction(self: mitsuba.cuda_ad_rgb.MediumPtr) -> drjit.cuda.ad.Bool:
        """
        Returns whether this medium has a spectrally varying extinction
        """
        ...

    def intersect_aabb(self: mitsuba.cuda_ad_rgb.MediumPtr, ray: mitsuba.cuda_ad_rgb.Ray3f) -> Tuple[drjit.cuda.ad.Bool, drjit.cuda.ad.Float, drjit.cuda.ad.Float]:
        """
        Intersects a ray with the medium's bounding box
        """
        ...

    def is_homogeneous(self: mitsuba.cuda_ad_rgb.MediumPtr) -> drjit.cuda.ad.Bool:
        """
        Returns whether this medium is homogeneous
        """
        ...

    def phase_function(self: mitsuba.cuda_ad_rgb.MediumPtr):
        """
        Return the phase function of this medium
        """
        ...

    def sample_interaction(self: mitsuba.cuda_ad_rgb.MediumPtr, ray: mitsuba.cuda_ad_rgb.Ray3f, sample: drjit.cuda.ad.Float, channel: drjit.cuda.ad.UInt, active: drjit.cuda.ad.Bool):
        """
        Sample a free-flight distance in the medium.
    ...
    def use_emitter_sampling(self: mitsuba.cuda_ad_rgb.MediumPtr) -> drjit.cuda.ad.Bool:
        """
        Returns whether this specific medium instance uses emitter sampling
        """
        ...
...
class Mesh(Shape):
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Mesh, props: mitsuba.Properties) -> None:
        """
        2. __init__(self: mitsuba.cuda_ad_rgb.Mesh, name: str, vertex_count: int, face_count: int, props: mitsuba.scalar_rgb.Properties = Properties[
          plugin_name = "",
          id = "",
          elements = {
          }
    ...
    def add_attribute(self: mitsuba.cuda_ad_rgb.Mesh, name: str, size: int, buffer: List[float]) -> None:
        """
    ...
    @overload
    def bbox(self: mitsuba.cuda_ad_rgb.Shape) -> mitsuba.BoundingBox3f:
        """
    ...
    @overload
    def bbox(self: mitsuba.cuda_ad_rgb.Shape, index: int) -> mitsuba.BoundingBox3f:
        """
    ...
    @overload
    def bbox(self: mitsuba.cuda_ad_rgb.Shape, index: int, clip: mitsuba.BoundingBox3f) -> mitsuba.BoundingBox3f:
        """
    ...
    def bsdf(self: mitsuba.cuda_ad_rgb.Shape):
        """
        Return the shape's BSDF
        """
        ...

    def compute_surface_interaction(self: mitsuba.cuda_ad_rgb.Shape, ray: mitsuba.cuda_ad_rgb.Ray3f, piy_flags: int = 14, active: drjit.cuda.ad.Bool = True):
        """
    ...
    def effective_primitive_count(self: mitsuba.cuda_ad_rgb.Shape) -> int:
        """
    ...
    def emitter(self: mitsuba.cuda_ad_rgb.Shape):
        """
        Return the area emitter associated with this shape (if any)
        """
        ...

    def eval_attribute(self: mitsuba.cuda_ad_rgb.Shape, name: str, si, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_attribute_1(self: mitsuba.cuda_ad_rgb.Shape, name: str, si, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def eval_attribute_3(self: mitsuba.cuda_ad_rgb.Shape, name: str, si, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_parameterization(self: mitsuba.cuda_ad_rgb.Mesh, uv: mitsuba.cuda_ad_rgb.Point2f, ray_flags: int = 14, active: drjit.cuda.ad.Bool = True): ...
    def expand(self: mitsuba.Object) -> list:
        """
        Expand the object into a list of sub-objects and return them
    ...
    def exterior_medium(self: mitsuba.cuda_ad_rgb.Shape):
        """
        Return the medium that lies on the exterior of this shape
        """
        ...

    def face_count(self: mitsuba.cuda_ad_rgb.Mesh) -> int:
        """
        Return the total number of faces
        """
        ...

    def face_indices(self: mitsuba.cuda_ad_rgb.Mesh, index: drjit.cuda.ad.UInt, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Array3u:
        """
        Returns the face indices associated with triangle ``index``
        """
        ...

    def has_vertex_normals(self: mitsuba.cuda_ad_rgb.Mesh) -> bool:
        """
        Does this mesh have per-vertex normals?
        """
        ...

    def has_vertex_texcoords(self: mitsuba.cuda_ad_rgb.Mesh) -> bool:
        """
        Does this mesh have per-vertex texture coordinates?
        """
        ...

    def id(self: mitsuba.cuda_ad_rgb.Shape) -> str:
        """
        Return a string identifier
        """
        ...
    ...
    def initialize(self: mitsuba.cuda_ad_rgb.Mesh) -> None:
        """
        Must be called at the end of the constructor of Mesh plugins
        """
        ...

    def interior_medium(self: mitsuba.cuda_ad_rgb.Shape):
        """
        Return the medium that lies on the interior of this shape
        """
        ...

    def is_emitter(self: mitsuba.cuda_ad_rgb.Shape) -> bool:
        """
        Is this shape also an area emitter?
        """
        ...

    def is_medium_transition(self: mitsuba.cuda_ad_rgb.Shape) -> bool:
        """
        Does the surface of this shape mark a medium transition?
        """
        ...

    def is_mesh(self: mitsuba.cuda_ad_rgb.Shape) -> bool:
        """
        Is this shape a triangle mesh?
        """
        ...

    def is_sensor(self: mitsuba.cuda_ad_rgb.Shape) -> bool:
        """
    ...
    def parameters_grad_enabled(self: mitsuba.cuda_ad_rgb.Shape) -> bool:
        """
    ...
    def pdf_direction(self: mitsuba.cuda_ad_rgb.Shape, it, ps, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def pdf_position(self: mitsuba.cuda_ad_rgb.Shape, ps, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def primitive_count(self: mitsuba.cuda_ad_rgb.Shape) -> int:
        """
    ...
    def ray_intersect(self: mitsuba.cuda_ad_rgb.Shape, ray: mitsuba.cuda_ad_rgb.Ray3f, ray_flags: int = 14, active: drjit.cuda.ad.Bool = True):
        """
    ...
    @overload
    def ray_intersect_preliminary(self: mitsuba.cuda_ad_rgb.Shape, ray: mitsuba.cuda_ad_rgb.Ray3f, active: drjit.cuda.ad.Bool = True):
        """
    ...
    def ray_intersect_triangle(self: mitsuba.cuda_ad_rgb.Mesh, index: drjit.cuda.ad.UInt, ray: mitsuba.cuda_ad_rgb.Ray3f, active: drjit.cuda.ad.Bool = True): ...
    def ray_test(self: mitsuba.cuda_ad_rgb.Shape, ray: mitsuba.cuda_ad_rgb.Ray3f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Bool:
        """
    ...
    def sample_direction(self: mitsuba.cuda_ad_rgb.Shape, it, sample: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True):
        """
    ...
    def sample_position(self: mitsuba.cuda_ad_rgb.Shape, time: drjit.cuda.ad.Float, sample: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True):
        """
    ...
    def sensor(self: mitsuba.cuda_ad_rgb.Shape):
        """
    ...
    def surface_area(self: mitsuba.cuda_ad_rgb.Shape) -> drjit.cuda.ad.Float:
        """
    ...
    def vertex_count(self: mitsuba.cuda_ad_rgb.Mesh) -> int:
        """
        Return the total number of vertices
        """
        ...

    def vertex_normal(self: mitsuba.cuda_ad_rgb.Mesh, index: drjit.cuda.ad.UInt, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Normal3f:
        """
        Returns the normal direction of the vertex with index ``index``
        """
        ...

    def vertex_position(self: mitsuba.cuda_ad_rgb.Mesh, index: drjit.cuda.ad.UInt, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Point3f:
        """
        Returns the world-space position of the vertex with index ``index``
        """
        ...

    def vertex_texcoord(self: mitsuba.cuda_ad_rgb.Mesh, index: drjit.cuda.ad.UInt, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Point2f:
        """
        Returns the UV texture coordinates of the vertex with index ``index``
        """
        ...

    def write_ply(self: mitsuba.cuda_ad_rgb.Mesh, filename: str) -> None:
        """
...
class MicrofacetDistribution:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha: float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha_u: float, alpha_v: float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha: drjit.cuda.ad.Float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, type: mitsuba.MicrofacetType, alpha_u: drjit.cuda.ad.Float, alpha_v: drjit.cuda.ad.Float, sample_visible: bool = True) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, arg0: mitsuba.Properties) -> None: ...
    def G(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, wi: mitsuba.cuda_ad_rgb.Vector3f, wo: mitsuba.cuda_ad_rgb.Vector3f, m: mitsuba.cuda_ad_rgb.Vector3f) -> drjit.cuda.ad.Float:
        """
        Smith's separable shadowing-masking approximation
        """
        ...

    def alpha(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution) -> drjit.cuda.ad.Float:
        """
        Return the roughness (isotropic case)
        """
        ...

    def alpha_u(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution) -> drjit.cuda.ad.Float:
        """
        Return the roughness along the tangent direction
        """
        ...

    def alpha_v(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution) -> drjit.cuda.ad.Float:
        """
        Return the roughness along the bitangent direction
        """
        ...

    def eval(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, m: mitsuba.cuda_ad_rgb.Vector3f) -> drjit.cuda.ad.Float:
        """
    ...
    def is_anisotropic(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution) -> bool:
        """
        Is this an anisotropic microfacet distribution?
        """
        ...

    def is_isotropic(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution) -> bool:
        """
        Is this an isotropic microfacet distribution?
        """
        ...

    def pdf(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, wi: mitsuba.cuda_ad_rgb.Vector3f, m: mitsuba.cuda_ad_rgb.Vector3f) -> drjit.cuda.ad.Float:
        """
    ...
    def sample(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, wi: mitsuba.cuda_ad_rgb.Vector3f, sample: mitsuba.cuda_ad_rgb.Point2f) -> Tuple[mitsuba.cuda_ad_rgb.Normal3f, drjit.cuda.ad.Float]:
        """
    ...
    def sample_visible(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution) -> bool:
        """
        Return whether or not only visible normals are sampled?
        """
        ...

    def sample_visible_11(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, cos_theta_i: drjit.cuda.ad.Float, sample: mitsuba.cuda_ad_rgb.Point2f) -> mitsuba.cuda_ad_rgb.Vector2f:
        """
        Visible normal sampling code for the alpha=1 case
        """
        ...

    def scale_alpha(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, value: drjit.cuda.ad.Float) -> None:
        """
        Scale the roughness values by some constant
        """
        ...

    def smith_g1(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution, v: mitsuba.cuda_ad_rgb.Vector3f, m: mitsuba.cuda_ad_rgb.Vector3f) -> drjit.cuda.ad.Float:
        """
    ...
    def type(self: mitsuba.cuda_ad_rgb.MicrofacetDistribution) -> mitsuba.MicrofacetType:
        """
...
class Normal3d(Array3f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Normal3d, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class Normal3f(Array3f):
    def __init__(self: mitsuba.cuda_ad_rgb.Normal3f, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
from drjit import ArrayBase
class ObjectPtr(ArrayBase):
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.ObjectPtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.ObjectPtr, arg0: mitsuba.Object) -> None: ...
    index = ...
    label = ...

    def assign(self: mitsuba.cuda_ad_rgb.ObjectPtr, arg0: mitsuba.cuda_ad_rgb.ObjectPtr) -> None: ...
    ...
...
class PhaseFunction(Object):
    def __init__(self: mitsuba.cuda_ad_rgb.PhaseFunction, arg0: mitsuba.Properties) -> None: ...
    m_flags = ...
    ptr = ...

    def component_count(self: mitsuba.cuda_ad_rgb.PhaseFunction, active: drjit.cuda.ad.Bool = True) -> int:
        """
    ...
    def eval(self: mitsuba.cuda_ad_rgb.PhaseFunction, ctx: mitsuba.cuda_ad_rgb.PhaseFunctionContext, mi: mitsuba.cuda_ad_rgb.MediumInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    @overload
    def flags(self: mitsuba.cuda_ad_rgb.PhaseFunction, index: int, active: drjit.cuda.ad.Bool = True) -> int:
        """
    ...
    @overload
    def flags(self: mitsuba.cuda_ad_rgb.PhaseFunction, active: drjit.cuda.ad.Bool = True) -> int:
        """
        Flags for this phase function.
        """
        ...

    def id(self: mitsuba.cuda_ad_rgb.PhaseFunction) -> str:
        """
        Return a string identifier
        """
        ...
    ...
    def max_projected_area(self: mitsuba.cuda_ad_rgb.PhaseFunction) -> drjit.cuda.ad.Float:
        """
    ...
    def projected_area(self: mitsuba.cuda_ad_rgb.PhaseFunction, mi: mitsuba.cuda_ad_rgb.MediumInteraction3f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def sample(self: mitsuba.cuda_ad_rgb.PhaseFunction, ctx: mitsuba.cuda_ad_rgb.PhaseFunctionContext, mi: mitsuba.cuda_ad_rgb.MediumInteraction3f, sample1: drjit.cuda.ad.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Vector3f, drjit.cuda.ad.Float]:
        """
...
class PhaseFunctionContext:
    def __init__(self: mitsuba.cuda_ad_rgb.PhaseFunctionContext, sampler, mode: mitsuba.TransportMode = <TransportMode.Radiance: 0>) -> None:
        """
        //! @}
        """
        ...
    ...
    def reverse(self: mitsuba.cuda_ad_rgb.PhaseFunctionContext) -> None:
        """
        Reverse the direction of light transport in the record
...
from drjit import ArrayBase
class PhaseFunctionPtr(ArrayBase):
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr, arg0: mitsuba.cuda_ad_rgb.PhaseFunction) -> None: ...
    index = ...
    label = ...

    def assign(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr, arg0: mitsuba.cuda_ad_rgb.PhaseFunctionPtr) -> None: ...
    def component_count(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.UInt64:
        """
        Number of components this phase function is comprised of.
        """
        ...

    def eval(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr, ctx: mitsuba.cuda_ad_rgb.PhaseFunctionContext, mi: mitsuba.cuda_ad_rgb.MediumInteraction3f, wo: mitsuba.cuda_ad_rgb.Vector3f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluates the phase function model
    ...
    def flags(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.UInt:
        """
        Flags for this phase function.
        """
        ...

    def max_projected_area(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr) -> drjit.cuda.ad.Float:
        """
        Return the maximum projected area of the microflake distribution
        """
        ...

    def projected_area(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr, mi: mitsuba.cuda_ad_rgb.MediumInteraction3f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Returns the microflake projected area
    ...
    def sample(self: mitsuba.cuda_ad_rgb.PhaseFunctionPtr, ctx: mitsuba.cuda_ad_rgb.PhaseFunctionContext, mi: mitsuba.cuda_ad_rgb.MediumInteraction3f, sample1: drjit.cuda.ad.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Vector3f, drjit.cuda.ad.Float]:
        """
        Importance sample the phase function model
...
class Point0d(Array0f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Point0d, *args) -> None: ...
    label = ...
...
class Point0f(Array0f):
    def __init__(self: mitsuba.cuda_ad_rgb.Point0f, *args) -> None: ...
    label = ...

    def assign(self, other): ...
    ...

from drjit.cuda.ad import Array0i
class Point0i(Array0i):
    def __init__(self: mitsuba.cuda_ad_rgb.Point0i, *args) -> None: ...
    label = ...

    def assign(self, other): ...
    ...

from drjit.cuda.ad import Array0u
class Point0u(Array0u):
    def __init__(self: mitsuba.cuda_ad_rgb.Point0u, *args) -> None: ...
    label = ...
...
class Point1d(Array1f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Point1d, *args) -> None: ...
    label = ...
    x = ...
...
class Point1f(Array1f):
    def __init__(self: mitsuba.cuda_ad_rgb.Point1f, *args) -> None: ...
    label = ...
    x = ...
...
from drjit.cuda.ad import Array1i
class Point1i(Array1i):
    def __init__(self: mitsuba.cuda_ad_rgb.Point1i, *args) -> None: ...
    label = ...
    x = ...
...
from drjit.cuda.ad import Array1u
class Point1u(Array1u):
    def __init__(self: mitsuba.cuda_ad_rgb.Point1u, *args) -> None: ...
    label = ...
    x = ...
...
from drjit.cuda.ad import Array2f64
class Point2d(Array2f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Point2d, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
class Point2f(Array2f):
    def __init__(self: mitsuba.cuda_ad_rgb.Point2f, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
from drjit.cuda.ad import Array2i
class Point2i(Array2i):
    def __init__(self: mitsuba.cuda_ad_rgb.Point2i, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
from drjit.cuda.ad import Array2u
class Point2u(Array2u):
    def __init__(self: mitsuba.cuda_ad_rgb.Point2u, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
class Point3d(Array3f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Point3d, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
class Point3f(Array3f):
    def __init__(self: mitsuba.cuda_ad_rgb.Point3f, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
from drjit.cuda.ad import Array3i
class Point3i(Array3i):
    def __init__(self: mitsuba.cuda_ad_rgb.Point3i, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
from drjit.cuda.ad import Array3u
class Point3u(Array3u):
    def __init__(self: mitsuba.cuda_ad_rgb.Point3u, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
from drjit.cuda.ad import Array4f64
class Point4d(Array4f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Point4d, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
from drjit.cuda.ad import Array4f
class Point4f(Array4f):
    def __init__(self: mitsuba.cuda_ad_rgb.Point4f, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
from drjit.cuda.ad import Array4i
class Point4i(Array4i):
    def __init__(self: mitsuba.cuda_ad_rgb.Point4i, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
from drjit.cuda.ad import Array4u
class Point4u(Array4u):
    def __init__(self: mitsuba.cuda_ad_rgb.Point4u, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
class PositionSample3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.PositionSample3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.PositionSample3f, other: mitsuba.cuda_ad_rgb.PositionSample3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.PositionSample3f, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f) -> None:
        """
        Create a position sampling record from a surface intersection
    ...
    def assign(self: mitsuba.cuda_ad_rgb.PositionSample3f, arg0: mitsuba.cuda_ad_rgb.PositionSample3f) -> None: ...
    ...
...
class PreliminaryIntersection3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.PreliminaryIntersection3f) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.PreliminaryIntersection3f, arg0: mitsuba.cuda_ad_rgb.PreliminaryIntersection3f) -> None:
        """
        Copy constructor
        """
        ...
    ...
    def assign(self: mitsuba.cuda_ad_rgb.PreliminaryIntersection3f, arg0: mitsuba.cuda_ad_rgb.PreliminaryIntersection3f) -> None: ...
    def compute_surface_interaction(self: mitsuba.cuda_ad_rgb.PreliminaryIntersection3f, ray: mitsuba.cuda_ad_rgb.Ray3f, ray_flags: int = 14, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.SurfaceInteraction3f:
        """
        Compute and return detailed information related to a surface
        interaction
    ...
    def is_valid(self: mitsuba.cuda_ad_rgb.PreliminaryIntersection3f) -> drjit.cuda.ad.Bool:
        """
        Is the current interaction valid?
        """
        ...
...
class ProjectiveCamera(Sensor):
    ...
    def far_clip(self: mitsuba.cuda_ad_rgb.ProjectiveCamera) -> float:
        """
        Return the far clip plane distance
        """
        ...

    def film(self: mitsuba.cuda_ad_rgb.Sensor) -> mitsuba.cuda_ad_rgb.Film:
        """
        Return the Film instance associated with this sensor
        """
        ...

    def focus_distance(self: mitsuba.cuda_ad_rgb.ProjectiveCamera) -> float:
        """
    ...
    def near_clip(self: mitsuba.cuda_ad_rgb.ProjectiveCamera) -> float:
        """
        Return the near clip plane distance
        """
        ...

    def needs_aperture_sample(self: mitsuba.cuda_ad_rgb.Sensor) -> bool:
        """
    ...
    def sample_ray_differential(self: mitsuba.cuda_ad_rgb.Sensor, time: drjit.cuda.ad.Float, sample1: drjit.cuda.ad.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, sample3: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.RayDifferential3f, mitsuba.cuda_ad_rgb.Color3f]: ...
    def sample_wavelengths(self: mitsuba.cuda_ad_rgb.Endpoint, si, sample: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color0f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample a set of wavelengths according to the endpoint's
        sensitivity/emission spectrum.
    ...
    def sampler(self: mitsuba.cuda_ad_rgb.Sensor) -> mitsuba.cuda_ad_rgb.Sampler:
        """
    ...
    def shutter_open(self: mitsuba.cuda_ad_rgb.Sensor) -> float:
        """
        Return the time value of the shutter opening event
        """
        ...

    def shutter_open_time(self: mitsuba.cuda_ad_rgb.Sensor) -> float:
        """
...
class RadicalInverse(Object):
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.RadicalInverse, max_base: int = 8161, scramble: int = -1) -> None: ...
    ptr = ...

    def base(self: mitsuba.cuda_ad_rgb.RadicalInverse, arg0: int) -> int:
        """
    ...
    def bases(self: mitsuba.cuda_ad_rgb.RadicalInverse) -> int:
        """
    ...
    def eval(self: mitsuba.cuda_ad_rgb.RadicalInverse, base_index: int, index: drjit.cuda.ad.UInt64) -> drjit.cuda.ad.Float:
        """
    ...
    def inverse_permutation(self: mitsuba.cuda_ad_rgb.RadicalInverse, arg0: int) -> int:
        """
    ...
    def scramble(self: mitsuba.cuda_ad_rgb.RadicalInverse) -> int:
        """
...
class Ray2f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray2f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray2f, other: mitsuba.cuda_ad_rgb.Ray2f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray2f, o: mitsuba.cuda_ad_rgb.Point2f, d: mitsuba.cuda_ad_rgb.Vector2f, time: drjit.cuda.ad.Float = 0.0, wavelengths: mitsuba.cuda_ad_rgb.Color0f = []) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray2f, o: mitsuba.cuda_ad_rgb.Point2f, d: mitsuba.cuda_ad_rgb.Vector2f, maxt: drjit.cuda.ad.Float, time: drjit.cuda.ad.Float, wavelengths: mitsuba.cuda_ad_rgb.Color0f) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray2f, other: mitsuba.cuda_ad_rgb.Ray2f, maxt: drjit.cuda.ad.Float) -> None: ...
    def __call__(self: mitsuba.cuda_ad_rgb.Ray2f, t: drjit.cuda.ad.Float) -> mitsuba.cuda_ad_rgb.Point2f:
        """
    ...
    def assign(self: mitsuba.cuda_ad_rgb.Ray2f, arg0: mitsuba.cuda_ad_rgb.Ray2f) -> None: ...
    ...
...
class Ray3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray3f) -> None:
        """
        Create an uninitialized ray
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray3f, other: mitsuba.cuda_ad_rgb.Ray3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray3f, o: mitsuba.cuda_ad_rgb.Point3f, d: mitsuba.cuda_ad_rgb.Vector3f, time: drjit.cuda.ad.Float = 0.0, wavelengths: mitsuba.cuda_ad_rgb.Color0f = []) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray3f, o: mitsuba.cuda_ad_rgb.Point3f, d: mitsuba.cuda_ad_rgb.Vector3f, maxt: drjit.cuda.ad.Float, time: drjit.cuda.ad.Float, wavelengths: mitsuba.cuda_ad_rgb.Color0f) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Ray3f, other: mitsuba.cuda_ad_rgb.Ray3f, maxt: drjit.cuda.ad.Float) -> None: ...
    def __call__(self: mitsuba.cuda_ad_rgb.Ray3f, t: drjit.cuda.ad.Float) -> mitsuba.cuda_ad_rgb.Point3f:
        """
        Return the position of a point along the ray
        """
        ...
    ...
    def assign(self: mitsuba.cuda_ad_rgb.Ray3f, arg0: mitsuba.cuda_ad_rgb.Ray3f) -> None: ...
    ...
...
class RayDifferential3f(Ray3f):
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.RayDifferential3f) -> None:
        """
        Create an uninitialized ray
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.RayDifferential3f, ray: mitsuba.cuda_ad_rgb.Ray3f) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.RayDifferential3f, o: mitsuba.cuda_ad_rgb.Point3f, d: mitsuba.cuda_ad_rgb.Vector3f, time: drjit.cuda.ad.Float = 0.0, wavelengths: mitsuba.cuda_ad_rgb.Color0f = []) -> None:
        """
    ...
    def assign(self: mitsuba.cuda_ad_rgb.RayDifferential3f, arg0: mitsuba.cuda_ad_rgb.RayDifferential3f) -> None: ...
    def scale_differential(self: mitsuba.cuda_ad_rgb.RayDifferential3f, amount: drjit.cuda.ad.Float) -> None: ...
    ...
...
class ReconstructionFilter(Object):
    ...
    def border_size(self: mitsuba.cuda_ad_rgb.ReconstructionFilter) -> int:
        """
        Return the block border size required when rendering with this filter
        """
        ...
    ...
    def eval(self: mitsuba.cuda_ad_rgb.ReconstructionFilter, x: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the filter function
        """
        ...

    def eval_discretized(self: mitsuba.cuda_ad_rgb.ReconstructionFilter, x: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate a discretized version of the filter (generally faster than
        'eval')
        """
    ...
    def is_box_filter(self: mitsuba.cuda_ad_rgb.ReconstructionFilter) -> bool:
        """
        Check whether this is a box filter?
        """
        ...
    ...
    def radius(self: mitsuba.cuda_ad_rgb.ReconstructionFilter) -> float:
        """
        Return the filter's width
        """
        ...
...
class Sampler(Object):
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.Sampler, props: mitsuba.Properties) -> None: ...
    ptr = ...

    def advance(self: mitsuba.cuda_ad_rgb.Sampler) -> None:
        """
    ...
    def clone(self: mitsuba.cuda_ad_rgb.Sampler) -> mitsuba.cuda_ad_rgb.Sampler:
        """
    ...
    def fork(self: mitsuba.cuda_ad_rgb.Sampler) -> mitsuba.cuda_ad_rgb.Sampler:
        """
    ...
    def loop_put(self: mitsuba.cuda_ad_rgb.Sampler, loop: drjit.cuda.ad.LoopBase) -> None:
        """
        Register internal state of this sampler with a symbolic loop
        """
        ...

    def next_1d(self: mitsuba.cuda_ad_rgb.Sampler, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Retrieve the next component value from the current sample
        """
        ...

    def next_2d(self: mitsuba.cuda_ad_rgb.Sampler, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Point2f:
        """
    ...
    def sample_count(self: mitsuba.cuda_ad_rgb.Sampler) -> int:
        """
        Return the number of samples per pixel
        """
        ...

    def schedule_state(self: mitsuba.cuda_ad_rgb.Sampler) -> None:
        """
        dr::schedule() variables that represent the internal sampler state
        """
        ...

    def seed(self: mitsuba.cuda_ad_rgb.Sampler, seed: int, wavefront_size: int = 4294967295) -> None:
        """
    ...
    def set_sample_count(self: mitsuba.cuda_ad_rgb.Sampler, spp: int) -> None:
        """
        Set the number of samples per pixel
        """
        ...

    def set_samples_per_wavefront(self: mitsuba.cuda_ad_rgb.Sampler, samples_per_wavefront: int) -> None:
        """
    ...
    def wavefront_size(self: mitsuba.cuda_ad_rgb.Sampler) -> int:
        """
...
class SamplingIntegrator(Integrator):
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.SamplingIntegrator, arg0: mitsuba.Properties) -> None: ...
    ptr = ...
...
class Scene(Object):
    ...
    * Sampling directions approximately proportional to the direct
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.Scene, arg0: mitsuba.Properties) -> None: ...
    ptr = ...

    def bbox(self: mitsuba.cuda_ad_rgb.Scene) -> mitsuba.BoundingBox3f:
        """
    ...
    def emitters(self: mitsuba.cuda_ad_rgb.Scene):
        """
        Return the list of emitters
        """
        ...

    def emitters_dr(self: mitsuba.cuda_ad_rgb.Scene):
        """
        Return the list of emitters as an Dr.Jit array
        """
        ...

    def environment(self: mitsuba.cuda_ad_rgb.Scene):
        """
        Return the environment emitter (if any)
        """
        ...

    def eval_emitter_direction(self: mitsuba.cuda_ad_rgb.Scene, ref, ds, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def integrator(self: mitsuba.cuda_ad_rgb.Scene) -> object:
        """
    ...
    def pdf_emitter(self: mitsuba.cuda_ad_rgb.Scene, index: drjit.cuda.ad.UInt, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def pdf_emitter_direction(self: mitsuba.cuda_ad_rgb.Scene, ref, ds, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    @overload
    def ray_intersect(self: mitsuba.cuda_ad_rgb.Scene, ray: mitsuba.cuda_ad_rgb.Ray3f, active: drjit.cuda.ad.Bool = True):
        """
    ...
    @overload
    def ray_intersect(self: mitsuba.cuda_ad_rgb.Scene, ray: mitsuba.cuda_ad_rgb.Ray3f, ray_flags: int, coherent: drjit.cuda.ad.Bool, active: drjit.cuda.ad.Bool = True):
        """
        Intersect a ray with the shapes comprising the scene and return a
        detailed data structure describing the intersection, if one is found
    ...
    def ray_intersect_preliminary(self: mitsuba.cuda_ad_rgb.Scene, ray: mitsuba.cuda_ad_rgb.Ray3f, coherent: drjit.cuda.ad.Bool = False, active: drjit.cuda.ad.Bool = True):
        """
    ...
    @overload
    def ray_test(self: mitsuba.cuda_ad_rgb.Scene, ray: mitsuba.cuda_ad_rgb.Ray3f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Bool:
        """
        Intersect a ray with the shapes comprising the scene and return a
    ...
    @overload
    def ray_test(self: mitsuba.cuda_ad_rgb.Scene, ray: mitsuba.cuda_ad_rgb.Ray3f, coherent: drjit.cuda.ad.Bool, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Bool:
        """
        Intersect a ray with the shapes comprising the scene and return a
        boolean specifying whether or not an intersection was found.
    ...
    def sample_emitter(self: mitsuba.cuda_ad_rgb.Scene, sample: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> Tuple[drjit.cuda.ad.UInt, drjit.cuda.ad.Float, drjit.cuda.ad.Float]:
        """
    ...
    def sample_emitter_direction(self: mitsuba.cuda_ad_rgb.Scene, ref, sample: mitsuba.cuda_ad_rgb.Point2f, test_visibility: bool = True, active: drjit.cuda.ad.Bool = True):
        """
    ...
    def sensors(self: mitsuba.cuda_ad_rgb.Scene):
        """
    ...
    def shapes(self: mitsuba.cuda_ad_rgb.Scene) -> list:
        """
        Return the list of shapes
        """
        ...

    def shapes_dr(self: mitsuba.cuda_ad_rgb.Scene):
        """
        Return the list of shapes as an Dr.Jit array
        """
        ...

    def shapes_grad_enabled(self: mitsuba.cuda_ad_rgb.Scene) -> bool:
        """
...
class Sensor(Endpoint):
    def __init__(self: mitsuba.cuda_ad_rgb.Sensor, arg0: mitsuba.Properties) -> None: ...
    m_needs_sample_2 = ...
    m_needs_sample_3 = ...
    ptr = ...
...
from drjit import ArrayBase
class SensorPtr(ArrayBase):
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.SensorPtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.SensorPtr, arg0: mitsuba.cuda_ad_rgb.Sensor) -> None: ...
    index = ...
    label = ...

    def assign(self: mitsuba.cuda_ad_rgb.SensorPtr, arg0: mitsuba.cuda_ad_rgb.SensorPtr) -> None: ...
    def pdf_direction(self: mitsuba.cuda_ad_rgb.SensorPtr, it: mitsuba.cuda_ad_rgb.Interaction3f, ds: mitsuba.cuda_ad_rgb.DirectionSample3f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate the probability density of the *direct* sampling method
        implemented by the sample_direction() method.
    ...
    def sample_direction(self: mitsuba.cuda_ad_rgb.SensorPtr, it: mitsuba.cuda_ad_rgb.Interaction3f, sample: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.DirectionSample3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Given a reference point in the scene, sample a direction from the
        reference point towards the endpoint (ideally proportional to the
        emission/sensitivity profile)
    ...
    def sample_position(self: mitsuba.cuda_ad_rgb.SensorPtr, time: drjit.cuda.ad.Float, sample: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.PositionSample3f, drjit.cuda.ad.Float]:
        """
        Importance sample the spatial component of the emission or importance
        profile of the endpoint.
    ...
    def sample_ray(self: mitsuba.cuda_ad_rgb.SensorPtr, time: drjit.cuda.ad.Float, sample1: drjit.cuda.ad.Float, sample2: mitsuba.cuda_ad_rgb.Point2f, sample3: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Ray3f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample a ray proportional to the endpoint's
        sensitivity/emission profile.
    ...
    def sample_wavelengths(self: mitsuba.cuda_ad_rgb.SensorPtr, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, sample: drjit.cuda.ad.Float, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color0f, mitsuba.cuda_ad_rgb.Color3f]:
        """
        Importance sample a set of wavelengths according to the endpoint's
        sensitivity/emission spectrum.
    ...
    def shape(self: mitsuba.cuda_ad_rgb.SensorPtr) -> mitsuba.cuda_ad_rgb.ShapePtr:
        """
        Return the shape, to which the emitter is currently attached
        """
        ...
...
from drjit import ArrayBase
class ShapePtr(ArrayBase):
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.ShapePtr) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.ShapePtr, arg0: mitsuba.cuda_ad_rgb.Shape) -> None: ...
    index = ...
    label = ...

    def assign(self: mitsuba.cuda_ad_rgb.ShapePtr, arg0: mitsuba.cuda_ad_rgb.ShapePtr) -> None: ...
    def bsdf(self: mitsuba.cuda_ad_rgb.ShapePtr):
        """
        Return the shape's BSDF
        """
        ...

    def compute_surface_interaction(self: mitsuba.cuda_ad_rgb.ShapePtr, ray: mitsuba.cuda_ad_rgb.Ray3f, piy_flags: int = 14, active: drjit.cuda.ad.Bool = True):
        """
        Compute and return detailed information related to a surface
        interaction
    ...
    def emitter(self: mitsuba.cuda_ad_rgb.ShapePtr):
        """
        Return the area emitter associated with this shape (if any)
        """
        ...

    def eval_attribute(self: mitsuba.cuda_ad_rgb.ShapePtr, name: str, si, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Evaluate a specific shape attribute at the given surface interaction.
    ...
    def eval_attribute_1(self: mitsuba.cuda_ad_rgb.ShapePtr, name: str, si, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Monochromatic evaluation of a shape attribute at the given surface
        interaction
    ...
    def eval_attribute_3(self: mitsuba.cuda_ad_rgb.ShapePtr, name: str, si, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
        Trichromatic evaluation of a shape attribute at the given surface
        interaction
    ...
    def exterior_medium(self: mitsuba.cuda_ad_rgb.ShapePtr):
        """
        Return the medium that lies on the exterior of this shape
        """
        ...

    def interior_medium(self: mitsuba.cuda_ad_rgb.ShapePtr):
        """
        Return the medium that lies on the interior of this shape
        """
        ...

    def is_emitter(self: mitsuba.cuda_ad_rgb.ShapePtr) -> drjit.cuda.ad.Bool:
        """
        Is this shape also an area emitter?
        """
        ...

    def is_medium_transition(self: mitsuba.cuda_ad_rgb.ShapePtr) -> drjit.cuda.ad.Bool:
        """
        Does the surface of this shape mark a medium transition?
        """
        ...

    def is_sensor(self: mitsuba.cuda_ad_rgb.ShapePtr) -> drjit.cuda.ad.Bool:
        """
        Is this shape also an area sensor?
        """
        ...

    def ray_intersect(self: mitsuba.cuda_ad_rgb.ShapePtr, ray: mitsuba.cuda_ad_rgb.Ray3f, ray_flags: int = 14, active: drjit.cuda.ad.Bool = True):
        """
        Test for an intersection and return detailed information
    ...
    @overload
    def ray_intersect_preliminary(self: mitsuba.cuda_ad_rgb.ShapePtr, ray: mitsuba.cuda_ad_rgb.Ray3f, active: drjit.cuda.ad.Bool = True):
        """
        Fast ray intersection
    ...
    def ray_test(self: mitsuba.cuda_ad_rgb.ShapePtr, ray: mitsuba.cuda_ad_rgb.Ray3f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Bool:
        """
        Fast ray shadow test
    ...
    def sensor(self: mitsuba.cuda_ad_rgb.ShapePtr):
        """
        Return the area sensor associated with this shape (if any)
        """
        ...
...
class SurfaceInteraction3f(Interaction3f):
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, arg0: mitsuba.cuda_ad_rgb.SurfaceInteraction3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, ps, wavelengths: mitsuba.cuda_ad_rgb.Color0f) -> None:
        """
        Construct from a position sample. Unavailable fields such as `wi` and
        the partial derivatives are left uninitialized. The `shape` pointer is
        left uninitialized because we can't guarantee that the given
    ...
    def assign(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, arg0: mitsuba.cuda_ad_rgb.SurfaceInteraction3f) -> None: ...
    @overload
    def bsdf(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, ray: mitsuba.cuda_ad_rgb.RayDifferential3f):
        """
    ...
    @overload
    def bsdf(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f): ...
    def compute_uv_partials(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, ray: mitsuba.cuda_ad_rgb.RayDifferential3f) -> None:
        """
        Computes texture coordinate partials
        """
        ...

    def emitter(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, scene: mitsuba.cuda_ad_rgb.Scene, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.EmitterPtr:
        """
    ...
    def has_n_partials(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f) -> bool: ...
    def has_uv_partials(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f) -> bool: ...
    def initialize_sh_frame(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f) -> None:
        """
        Initialize local shading frame using Gram-schmidt orthogonalization
        """
        ...

    def is_medium_transition(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f) -> drjit.cuda.ad.Bool:
        """
        Does the surface mark a transition between two media?
        """
        ...

    def is_sensor(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f) -> drjit.cuda.ad.Bool:
        """
    ...
    @overload
    def target_medium(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, d: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.cuda_ad_rgb.MediumPtr:
        """
    ...
    @overload
    def target_medium(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, cos_theta: drjit.cuda.ad.Float) -> mitsuba.cuda_ad_rgb.MediumPtr:
        """
    ...
    def to_local(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, v: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.cuda_ad_rgb.Vector3f:
        """
        Convert a world-space vector into local shading coordinates
        """
        ...

    def to_local_mueller(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, M_world: mitsuba.cuda_ad_rgb.Color3f, wi_world: mitsuba.cuda_ad_rgb.Vector3f, wo_world: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def to_world(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, v: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.cuda_ad_rgb.Vector3f:
        """
        Convert a local shading-space vector into world space
        """
        ...

    def to_world_mueller(self: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, M_local: mitsuba.cuda_ad_rgb.Color3f, wi_local: mitsuba.cuda_ad_rgb.Vector3f, wo_local: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.cuda_ad_rgb.Color3f:
        """
...
class TensorXf64(ArrayBase):
    ...
    def 10. __init__(self: drjit.cuda.ad.TensorXf64, arg0: drjit.cuda.ad.TensorXf64) -> None: ...
    def 11. __init__(self: drjit.cuda.ad.TensorXf64, arg0: drjit.cuda.TensorXf64) -> None: ...
    array = ...
    index = ...
    index_ad = ...
    label = ...
...
class TensorXf(ArrayBase):
    ...
    def 10. __init__(self: drjit.cuda.ad.TensorXf, arg0: drjit.cuda.ad.TensorXf64) -> None: ...
    def 11. __init__(self: drjit.cuda.ad.TensorXf, arg0: drjit.cuda.TensorXf) -> None: ...
    array = ...
    index = ...
    index_ad = ...
    label = ...
...
class TensorXi(ArrayBase):
    ...
    def 10. __init__(self: drjit.cuda.ad.TensorXi, arg0: drjit.cuda.ad.TensorXf64) -> None: ...
    def 11. __init__(self: drjit.cuda.ad.TensorXi, arg0: drjit.cuda.TensorXi) -> None: ...
    array = ...
    index = ...
    index_ad = ...
    label = ...
...
class TensorXi64(ArrayBase):
    ...
    def 10. __init__(self: drjit.cuda.ad.TensorXi64, arg0: drjit.cuda.ad.TensorXf64) -> None: ...
    def 11. __init__(self: drjit.cuda.ad.TensorXi64, arg0: drjit.cuda.TensorXi64) -> None: ...
    array = ...
    index = ...
    index_ad = ...
    label = ...
...
class TensorXu(ArrayBase):
    ...
    def 10. __init__(self: drjit.cuda.ad.TensorXu, arg0: drjit.cuda.ad.TensorXf64) -> None: ...
    def 11. __init__(self: drjit.cuda.ad.TensorXu, arg0: drjit.cuda.TensorXu) -> None: ...
    array = ...
    index = ...
    index_ad = ...
    label = ...
...
class TensorXu64(ArrayBase):
    ...
    def 10. __init__(self: drjit.cuda.ad.TensorXu64, arg0: drjit.cuda.ad.TensorXf64) -> None: ...
    def 11. __init__(self: drjit.cuda.ad.TensorXu64, arg0: drjit.cuda.TensorXu64) -> None: ...
    array = ...
    index = ...
    index_ad = ...
    label = ...
...
class Texture(Object):
    ...
    def __init__(self: mitsuba.cuda_ad_rgb.Texture, props: mitsuba.Properties) -> None: ...
    ptr = ...
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Texture, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_1(self: mitsuba.cuda_ad_rgb.Texture, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
    ...
    def eval_1_grad(self: mitsuba.cuda_ad_rgb.Texture, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Vector2f:
        """
    ...
    def eval_3(self: mitsuba.cuda_ad_rgb.Texture, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def is_spatially_varying(self: mitsuba.cuda_ad_rgb.Texture) -> bool:
        """
        Does this texture evaluation depend on the UV coordinates
        """
        ...

    def max(self: mitsuba.cuda_ad_rgb.Texture) -> float:
        """
    ...
    def mean(self: mitsuba.cuda_ad_rgb.Texture) -> drjit.cuda.ad.Float:
        """
    ...
    def pdf_position(self: mitsuba.cuda_ad_rgb.Texture, p: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Returns the probability per unit area of sample_position()
        """
        ...

    def pdf_spectrum(self: mitsuba.cuda_ad_rgb.Texture, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color0f:
        """
    ...
    def resolution(self: mitsuba.cuda_ad_rgb.Texture) -> mitsuba.Vector2i:
        """
    ...
    def sample_position(self: mitsuba.cuda_ad_rgb.Texture, sample: mitsuba.cuda_ad_rgb.Point2f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Point2f, drjit.cuda.ad.Float]:
        """
    ...
    def sample_spectrum(self: mitsuba.cuda_ad_rgb.Texture, si: mitsuba.cuda_ad_rgb.SurfaceInteraction3f, sample: mitsuba.cuda_ad_rgb.Color0f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color0f, mitsuba.cuda_ad_rgb.Color3f]:
        """
    ...
    def spectral_resolution(self: mitsuba.cuda_ad_rgb.Texture) -> float:
        """
    ...
    def wavelength_range(self: mitsuba.cuda_ad_rgb.Texture) -> mitsuba.Vector2f:
        """
...
class Texture1f64:
    @overload
    def __init__(self: drjit.cuda.ad.Texture1f64, shape: List[int[1]], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = <FilterMode.Linear: 1>, wrap_mode: drjit.WrapMode = <WrapMode.Clamp: 1>) -> None: ...
    @overload
    def __init__(self: drjit.cuda.ad.Texture1f64, tensor: drjit.cuda.ad.TensorXf64, use_accel: bool = True, migrate: bool = True, filter_mode: drjit.FilterMode = <FilterMode.Linear: 1>, wrap_mode: drjit.WrapMode = <WrapMode.Clamp: 1>) -> None: ...
    shape = ...
...
class Texture1f:
    @overload
    def __init__(self: drjit.cuda.ad.Texture1f, shape: List[int[1]], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = <FilterMode.Linear: 1>, wrap_mode: drjit.WrapMode = <WrapMode.Clamp: 1>) -> None: ...
    @overload
    def __init__(self: drjit.cuda.ad.Texture1f, tensor: drjit.cuda.ad.TensorXf, use_accel: bool = True, migrate: bool = True, filter_mode: drjit.FilterMode = <FilterMode.Linear: 1>, wrap_mode: drjit.WrapMode = <WrapMode.Clamp: 1>) -> None: ...
    shape = ...
...
class Texture2f64:
    @overload
    def __init__(self: drjit.cuda.ad.Texture2f64, shape: List[int[2]], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = <FilterMode.Linear: 1>, wrap_mode: drjit.WrapMode = <WrapMode.Clamp: 1>) -> None: ...
    @overload
    def __init__(self: drjit.cuda.ad.Texture2f64, tensor: drjit.cuda.ad.TensorXf64, use_accel: bool = True, migrate: bool = True, filter_mode: drjit.FilterMode = <FilterMode.Linear: 1>, wrap_mode: drjit.WrapMode = <WrapMode.Clamp: 1>) -> None: ...
    shape = ...
...
class Texture2f:
    @overload
    def __init__(self: drjit.cuda.ad.Texture2f, shape: List[int[2]], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = <FilterMode.Linear: 1>, wrap_mode: drjit.WrapMode = <WrapMode.Clamp: 1>) -> None: ...
    @overload
    def __init__(self: drjit.cuda.ad.Texture2f, tensor: drjit.cuda.ad.TensorXf, use_accel: bool = True, migrate: bool = True, filter_mode: drjit.FilterMode = <FilterMode.Linear: 1>, wrap_mode: drjit.WrapMode = <WrapMode.Clamp: 1>) -> None: ...
    shape = ...
...
class Texture3f64:
    @overload
    def __init__(self: drjit.cuda.ad.Texture3f64, shape: List[int[3]], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = <FilterMode.Linear: 1>, wrap_mode: drjit.WrapMode = <WrapMode.Clamp: 1>) -> None: ...
    @overload
    def __init__(self: drjit.cuda.ad.Texture3f64, tensor: drjit.cuda.ad.TensorXf64, use_accel: bool = True, migrate: bool = True, filter_mode: drjit.FilterMode = <FilterMode.Linear: 1>, wrap_mode: drjit.WrapMode = <WrapMode.Clamp: 1>) -> None: ...
    shape = ...
...
class Texture3f:
    @overload
    def __init__(self: drjit.cuda.ad.Texture3f, shape: List[int[3]], channels: int, use_accel: bool = True, filter_mode: drjit.FilterMode = <FilterMode.Linear: 1>, wrap_mode: drjit.WrapMode = <WrapMode.Clamp: 1>) -> None: ...
    @overload
    def __init__(self: drjit.cuda.ad.Texture3f, tensor: drjit.cuda.ad.TensorXf, use_accel: bool = True, migrate: bool = True, filter_mode: drjit.FilterMode = <FilterMode.Linear: 1>, wrap_mode: drjit.WrapMode = <WrapMode.Clamp: 1>) -> None: ...
    shape = ...
...
class Transform3d:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3d) -> None:
        """
        Initialize with the identity matrix
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3d, arg0: mitsuba.cuda_ad_rgb.Transform3d) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3d, arg0: numpy.ndarray) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3d, arg0: list) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3d, arg0: drjit.cuda.ad.Matrix3f64) -> None:
        """
        Initialize the transformation from the given matrix (and compute its
        inverse transpose)
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3d, arg0: drjit.cuda.ad.Matrix3f64, arg1: drjit.cuda.ad.Matrix3f64) -> None:
        """
        Initialize from a matrix and its inverse transpose
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3d, arg0: mitsuba.Transform3d) -> None:
        """
...
class Transform3f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3f) -> None:
        """
        Initialize with the identity matrix
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3f, arg0: mitsuba.cuda_ad_rgb.Transform3f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3f, arg0: numpy.ndarray) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3f, arg0: list) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3f, arg0: drjit.cuda.ad.Matrix3f) -> None:
        """
        Initialize the transformation from the given matrix (and compute its
        inverse transpose)
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3f, arg0: drjit.cuda.ad.Matrix3f, arg1: drjit.cuda.ad.Matrix3f) -> None:
        """
        Initialize from a matrix and its inverse transpose
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform3f, arg0: mitsuba.Transform3f) -> None:
        """
        Broadcast constructor
        """
        ...
...
class Transform4d:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4d) -> None:
        """
        Initialize with the identity matrix
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4d, arg0: mitsuba.cuda_ad_rgb.Transform4d) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4d, arg0: numpy.ndarray) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4d, arg0: list) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4d, arg0: drjit.cuda.ad.Matrix4f64) -> None:
        """
        Initialize the transformation from the given matrix (and compute its
        inverse transpose)
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4d, arg0: drjit.cuda.ad.Matrix4f64, arg1: drjit.cuda.ad.Matrix4f64) -> None:
        """
        Initialize from a matrix and its inverse transpose
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4d, arg0: mitsuba.Transform4d) -> None:
        """
        Broadcast constructor
        """
        ...
...
class Transform4f:
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4f) -> None:
        """
        Initialize with the identity matrix
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4f, arg0: mitsuba.cuda_ad_rgb.Transform4f) -> None:
        """
        Copy constructor
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4f, arg0: numpy.ndarray) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4f, arg0: list) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4f, arg0: drjit.cuda.ad.Matrix4f) -> None:
        """
        Initialize the transformation from the given matrix (and compute its
        inverse transpose)
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4f, arg0: drjit.cuda.ad.Matrix4f, arg1: drjit.cuda.ad.Matrix4f) -> None:
        """
        Initialize from a matrix and its inverse transpose
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.Transform4f, arg0: mitsuba.Transform4f) -> None:
        """
        Broadcast constructor
        """
        ...
...
class UInt(ArrayBase):
    ...
    def 10. __init__(self: drjit.cuda.ad.UInt, *args) -> None: ...
    index = ...
    index_ad = ...
    label = ...
...
class UInt64(ArrayBase):
    ...
    def 10. __init__(self: drjit.cuda.ad.UInt64, *args) -> None: ...
    index = ...
    index_ad = ...
    label = ...
...
from drjit.cuda.ad import Array0f64
class Vector0d(Array0f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector0d, *args) -> None: ...
    label = ...
...
from drjit.cuda.ad import Array0f
class Vector0f(Array0f):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector0f, *args) -> None: ...
    label = ...
...
from drjit.cuda.ad import Array0i
class Vector0i(Array0i):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector0i, *args) -> None: ...
    label = ...
...
from drjit.cuda.ad import Array0u
class Vector0u(Array0u):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector0u, *args) -> None: ...
    label = ...
...
from drjit.cuda.ad import Array1f64
class Vector1d(Array1f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector1d, *args) -> None: ...
    label = ...
    x = ...
...
from drjit.cuda.ad import Array1f
class Vector1f(Array1f):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector1f, *args) -> None: ...
    label = ...
    x = ...
...
from drjit.cuda.ad import Array1i
class Vector1i(Array1i):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector1i, *args) -> None: ...
    label = ...
    x = ...
...
from drjit.cuda.ad import Array1u
class Vector1u(Array1u):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector1u, *args) -> None: ...
    label = ...
    x = ...
...
from drjit.cuda.ad import Array2f64
class Vector2d(Array2f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector2d, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
from drjit.cuda.ad import Array2f
class Vector2f(Array2f):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector2f, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
from drjit.cuda.ad import Array2i
class Vector2i(Array2i):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector2i, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
from drjit.cuda.ad import Array2u
class Vector2u(Array2u):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector2u, *args) -> None: ...
    label = ...
    x = ...
    y = ...
...
from drjit.cuda.ad import Array3f64
class Vector3d(Array3f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector3d, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
from drjit.cuda.ad import Array3f
class Vector3f(Array3f):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector3f, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
from drjit.cuda.ad import Array3i
class Vector3i(Array3i):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector3i, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
from drjit.cuda.ad import Array3u
class Vector3u(Array3u):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector3u, *args) -> None: ...
    label = ...
    x = ...
    y = ...
    z = ...
...
from drjit.cuda.ad import Array4f64
class Vector4d(Array4f64):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector4d, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
from drjit.cuda.ad import Array4f
class Vector4f(Array4f):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector4f, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
from drjit.cuda.ad import Array4i
class Vector4i(Array4i):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector4i, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
from drjit.cuda.ad import Array4u
class Vector4u(Array4u):
    def __init__(self: mitsuba.cuda_ad_rgb.Vector4u, *args) -> None: ...
    label = ...
    w = ...
    x = ...
    y = ...
...
class Volume(Object):
    ...
    def bbox(self: mitsuba.cuda_ad_rgb.Volume) -> mitsuba.BoundingBox3f:
        """
        Returns the bounding box of the volume
        """
        ...

    def channel_count(self: mitsuba.cuda_ad_rgb.Volume) -> int:
        """
    ...
    def eval(self: mitsuba.cuda_ad_rgb.Volume, it: mitsuba.cuda_ad_rgb.Interaction3f, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
        """
    ...
    def eval_1(self: mitsuba.cuda_ad_rgb.Volume, it: mitsuba.cuda_ad_rgb.Interaction3f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float:
        """
        Evaluate this volume as a single-channel quantity.
        """
        ...

    def eval_3(self: mitsuba.cuda_ad_rgb.Volume, it: mitsuba.cuda_ad_rgb.Interaction3f, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Vector3f:
        """
    ...
    def eval_6(self: mitsuba.cuda_ad_rgb.Volume, it: mitsuba.cuda_ad_rgb.Interaction3f, active: drjit.cuda.ad.Bool = True) -> List[drjit.cuda.ad.Float[6]]:
        """
    ...
    def eval_gradient(self: mitsuba.cuda_ad_rgb.Volume, it: mitsuba.cuda_ad_rgb.Interaction3f, active: drjit.cuda.ad.Bool = True) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Vector3f]:
        """
    ...
    def eval_n(self: mitsuba.cuda_ad_rgb.Volume, it: mitsuba.cuda_ad_rgb.Interaction3f, active: drjit.cuda.ad.Bool = True) -> List[drjit.cuda.ad.Float]:
        """
    ...
    def max(self: mitsuba.cuda_ad_rgb.Volume) -> float:
        """
        Returns the maximum value of the volume over all dimensions.
        """
        ...

    def max_per_channel(self: mitsuba.cuda_ad_rgb.Volume) -> List[float]:
        """
    ...
    def resolution(self: mitsuba.cuda_ad_rgb.Volume) -> mitsuba.Vector3i:
        """
...
class VolumeGrid(Object):
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.VolumeGrid, array: numpy.ndarray[numpy.float32], compute_max: bool = True) -> None:
        """
    ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.VolumeGrid, path: mitsuba.filesystem.path) -> None: ...
    @overload
    def __init__(self: mitsuba.cuda_ad_rgb.VolumeGrid, stream: mitsuba.Stream) -> None: ...
    ptr = ...

    def buffer_size(self: mitsuba.cuda_ad_rgb.VolumeGrid) -> int:
        """
        Return the volume grid size in bytes (excluding metadata)
        """
        ...

    def bytes_per_voxel(self: mitsuba.cuda_ad_rgb.VolumeGrid) -> int:
        """
        Return the number bytes of storage used per voxel
        """
        ...

    def channel_count(self: mitsuba.cuda_ad_rgb.VolumeGrid) -> int:
        """
    ...
    def max(self: mitsuba.cuda_ad_rgb.VolumeGrid) -> float:
        """
        Return the precomputed maximum over the volume grid
        """
        ...

    def max_per_channel(self: mitsuba.cuda_ad_rgb.VolumeGrid) -> List[float]:
        """
    ...
    def set_max(self: mitsuba.cuda_ad_rgb.VolumeGrid, arg0: float) -> None:
        """
        Set the precomputed maximum over the volume grid
        """
        ...

    def set_max_per_channel(self: mitsuba.cuda_ad_rgb.VolumeGrid, arg0: List[float]) -> None:
        """
    ...
    def size(self: mitsuba.cuda_ad_rgb.VolumeGrid) -> mitsuba.Vector3u:
        """
    ...
    @overload
    def write(self: mitsuba.cuda_ad_rgb.VolumeGrid, stream: mitsuba.Stream) -> None:
        """
    ...
    @overload
    def write(self: mitsuba.cuda_ad_rgb.VolumeGrid, path: mitsuba.filesystem.path) -> None:
        """
...
def cie1931_xyz(wavelength: drjit.cuda.ad.Float) -> mitsuba.cuda_ad_rgb.Color3f:
    """
...
def cie1931_y(wavelength: drjit.cuda.ad.Float) -> drjit.cuda.ad.Float:
    """
...
def coordinate_system(n: mitsuba.cuda_ad_rgb.Vector3f) -> Tuple[mitsuba.cuda_ad_rgb.Vector3f, mitsuba.cuda_ad_rgb.Vector3f]:
    """
...
def depolarizer(arg0: mitsuba.cuda_ad_rgb.Color3f) -> mitsuba.cuda_ad_rgb.Color3f: ...
def eval_reflectance(type: mitsuba.MicrofacetType, alpha_u: float, alpha_v: float, wi: mitsuba.cuda_ad_rgb.Vector3f, eta: float) -> drjit.cuda.ad.Float: ...
...
errors defaults to 'strict'.
"""
def fresnel(cos_theta_i: drjit.cuda.ad.Float, eta: drjit.cuda.ad.Float) -> Tuple[drjit.cuda.ad.Float, drjit.cuda.ad.Float, drjit.cuda.ad.Float, drjit.cuda.ad.Float]:
    """
...
def fresnel_conductor(cos_theta_i: drjit.cuda.ad.Float, eta: drjit.cuda.ad.Complex2f) -> drjit.cuda.ad.Float:
    """
    Calculates the unpolarized Fresnel reflection coefficient at a planar
...
def fresnel_diffuse_reflectance(eta: drjit.cuda.ad.Float) -> drjit.cuda.ad.Float:
    """
...
def fresnel_polarized(cos_theta_i: drjit.cuda.ad.Float, eta: drjit.cuda.ad.Complex2f) -> Tuple[drjit.cuda.ad.Complex2f, drjit.cuda.ad.Complex2f, drjit.cuda.ad.Float, drjit.cuda.ad.Complex2f, drjit.cuda.ad.Complex2f]:
    """
...
@overload
def has_flag(arg0: drjit.cuda.ad.UInt, arg1: mitsuba.EmitterFlags) -> drjit.cuda.ad.Bool: ...
@overload
def has_flag(arg0: int, arg1: mitsuba.RayFlags) -> bool: ...
@overload
def has_flag(arg0: drjit.cuda.ad.UInt, arg1: mitsuba.RayFlags) -> drjit.cuda.ad.Bool: ...
@overload
def has_flag(arg0: int, arg1: mitsuba.BSDFFlags) -> bool: ...
@overload
def has_flag(arg0: drjit.cuda.ad.UInt, arg1: mitsuba.BSDFFlags) -> drjit.cuda.ad.Bool: ...
@overload
def has_flag(arg0: int, arg1: mitsuba.FilmFlags) -> bool: ...
@overload
def has_flag(arg0: drjit.cuda.ad.UInt, arg1: mitsuba.FilmFlags) -> drjit.cuda.ad.Bool: ...
@overload
def has_flag(arg0: int, arg1: mitsuba.PhaseFunctionFlags) -> bool: ...
def 10. has_flag(arg0: drjit.cuda.ad.UInt, arg1: mitsuba.PhaseFunctionFlags) -> bool: ...
is_monochromatic = ...
"""
bool(x) -> bool
...
The class bool is a subclass of the class int, and cannot be subclassed.
"""
def linear_rgb_rec(wavelength: drjit.cuda.ad.Float) -> mitsuba.cuda_ad_rgb.Color3f:
    """
...
def load_file(path: str, update_scene: bool = False, parallel: bool = False, **kwargs) -> object:
    """
...
def load_string(string: str, parallel: bool = False, **kwargs) -> object:
    """
...
@overload
def luminance(value: mitsuba.cuda_ad_rgb.Color3f, wavelengths: mitsuba.cuda_ad_rgb.Color3f, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.Float: ...
@overload
def luminance(c: mitsuba.cuda_ad_rgb.Color3f) -> drjit.cuda.ad.Float: ...
...
@overload
def pdf_rgb_spectrum(wavelengths: drjit.cuda.ad.Float) -> drjit.cuda.ad.Float:
    """
...
@overload
def pdf_rgb_spectrum(wavelengths: mitsuba.cuda_ad_rgb.Color3f) -> mitsuba.cuda_ad_rgb.Color3f:
    """
    PDF for the sample_rgb_spectrum strategy. It is valid to call this
    function for a single wavelength (Float), a set of wavelengths
    (Spectrumf), a packet of wavelengths (SpectrumfP), etc. In all cases,
...
def permute(value: drjit.cuda.ad.UInt, size: int, seed: drjit.cuda.ad.UInt, rounds: int = 4) -> drjit.cuda.ad.UInt:
    """
...
def permute_kensler(i: drjit.cuda.ad.UInt, l: int, p: drjit.cuda.ad.UInt, active: drjit.cuda.ad.Bool = True) -> drjit.cuda.ad.UInt:
    """
...
def perspective_projection(film_size: mitsuba.Vector2i, crop_size: mitsuba.Vector2i, crop_offset: mitsuba.Vector2i, fov_x: drjit.cuda.ad.Float, near_clip: drjit.cuda.ad.Float, far_clip: drjit.cuda.ad.Float) -> mitsuba.cuda_ad_rgb.Transform4f:
    """
...
def radical_inverse_2(index: drjit.cuda.ad.UInt, scramble: drjit.cuda.ad.UInt) -> drjit.cuda.ad.Float:
    """
...
@overload
def reflect(wi: mitsuba.cuda_ad_rgb.Vector3f) -> mitsuba.cuda_ad_rgb.Vector3f:
    """
...
@overload
def reflect(wi: mitsuba.cuda_ad_rgb.Vector3f, m: mitsuba.cuda_ad_rgb.Normal3f) -> mitsuba.cuda_ad_rgb.Vector3f:
    """
...
@overload
def refract(wi: mitsuba.cuda_ad_rgb.Vector3f, cos_theta_t: drjit.cuda.ad.Float, eta_ti: drjit.cuda.ad.Float) -> mitsuba.cuda_ad_rgb.Vector3f:
    """
...
@overload
def refract(wi: mitsuba.cuda_ad_rgb.Vector3f, m: mitsuba.cuda_ad_rgb.Normal3f, cos_theta_t: drjit.cuda.ad.Float, eta_ti: drjit.cuda.ad.Float) -> mitsuba.cuda_ad_rgb.Vector3f:
    """
...
@overload
def sample_rgb_spectrum(sample: drjit.cuda.ad.Float) -> Tuple[drjit.cuda.ad.Float, drjit.cuda.ad.Float]:
    """
...
@overload
def sample_rgb_spectrum(sample: mitsuba.cuda_ad_rgb.Color3f) -> Tuple[mitsuba.cuda_ad_rgb.Color3f, mitsuba.cuda_ad_rgb.Color3f]:
    """
    Importance sample a "importance spectrum" that concentrates the
    computation on wavelengths that are relevant for rendering of RGB data
...
@overload
def sample_tea_32(v0: drjit.cuda.ad.UInt, v1: drjit.cuda.ad.UInt, rounds: int = 4) -> Tuple[drjit.cuda.ad.UInt, drjit.cuda.ad.UInt]:
    """
    Generate fast and reasonably good pseudorandom numbers using the Tiny
    Encryption Algorithm (TEA) by David Wheeler and Roger Needham.
...
@overload
def sample_tea_64(v0: drjit.cuda.ad.UInt, v1: drjit.cuda.ad.UInt, rounds: int = 4) -> drjit.cuda.ad.UInt64:
    """
    Generate fast and reasonably good pseudorandom numbers using the Tiny
    Encryption Algorithm (TEA) by David Wheeler and Roger Needham.
...
@overload
def sample_tea_float64(v0: drjit.cuda.ad.UInt, v1: drjit.cuda.ad.UInt, rounds: int = 4) -> drjit.cuda.ad.Float64:
    """
    Generate fast and reasonably good pseudorandom numbers using the Tiny
    Encryption Algorithm (TEA) by David Wheeler and Roger Needham.
...
@overload
def sample_tea_float32(v0: drjit.cuda.ad.UInt, v1: drjit.cuda.ad.UInt, rounds: int = 4) -> drjit.cuda.ad.Float:
    """
    Generate fast and reasonably good pseudorandom numbers using the Tiny
    Encryption Algorithm (TEA) by David Wheeler and Roger Needham.
...
def sobol_2(index: drjit.cuda.ad.UInt, scramble: drjit.cuda.ad.UInt) -> drjit.cuda.ad.Float:
    """
...
def srgb_model_eval(arg0: drjit.cuda.ad.Array3f, arg1: mitsuba.cuda_ad_rgb.Color0f) -> mitsuba.cuda_ad_rgb.Color3f: ...
...
def srgb_model_mean(arg0: drjit.cuda.ad.Array3f) -> drjit.cuda.ad.Float: ...
def srgb_to_xyz(rgb: mitsuba.cuda_ad_rgb.Color3f, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
    """
...
def unpolarized_spectrum(arg0: mitsuba.cuda_ad_rgb.Color3f) -> mitsuba.cuda_ad_rgb.Color3f: ...
...
def xyz_to_srgb(rgb: mitsuba.cuda_ad_rgb.Color3f, active: drjit.cuda.ad.Bool = True) -> mitsuba.cuda_ad_rgb.Color3f:
    """
